...
$APKTOOL d -f $MIUI_JARS/patchrom-server.jar -o $OUT/patchrom-server
rm -rf $OUT/patchrom-server/smali/com/android/server/am/ActivityManagerServiceHook.smali
rm -rf $OUT/patchrom-server/smali/com/android/server/am/ActivityManagerServiceLifecycleHook.smali
rm -rf $OUT/patchrom-server/smali/com/android/server/notification
$APKTOOL b $OUT/patchrom-server -o $OUT/patchrom-server.jar
cp -rf $OUT/patchrom-server.jar $ZIP_DIR/system/framework/patchrom-server.jar
