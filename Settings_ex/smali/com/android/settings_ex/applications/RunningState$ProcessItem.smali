...
.method public constructor <init>(Landroid/content/Context;ILjava/lang/String;)V
    ...
    invoke-direct {p0, v1, v0}, Lcom/android/settings_ex/applications/RunningState$BaseItem;-><init>(ZI)V
...
.method ensureLabel(Landroid/content/pm/PackageManager;)V
    ...
    .line 418
    iget-object v7, p0, Lcom/android/settings_ex/applications/RunningState$ProcessItem;->mLabel:Ljava/lang/String;
    ...
    :cond_0
    :try_start_0
    iget-object v7, p0, Lcom/android/settings_ex/applications/RunningState$ProcessItem;->mProcessName:Ljava/lang/String;
    ...
    iput-object v7, p0, Lcom/android/settings_ex/applications/RunningState$ProcessItem;->mDisplayLabel:Ljava/lang/CharSequence;

    .line 427
    iget-object v7, p0, Lcom/android/settings_ex/applications/RunningState$ProcessItem;->mDisplayLabel:Ljava/lang/CharSequence;

    invoke-interface {v7}, Ljava/lang/CharSequence;->toString()Ljava/lang/String;

    move-result-object v7

    iput-object v7, p0, Lcom/android/settings_ex/applications/RunningState$ProcessItem;->mLabel:Ljava/lang/String;
    ...
    .line 436
    :cond_1
    iget v7, p0, Lcom/android/settings_ex/applications/RunningState$ProcessItem;->mUid:I
    ...
    .line 460
    iput-object v3, p0, Lcom/android/settings_ex/applications/RunningState$ProcessItem;->mDisplayLabel:Ljava/lang/CharSequence;
    ...
    :cond_4
    iget-object v6, p0, Lcom/android/settings_ex/applications/RunningState$ProcessItem;->mServices:Ljava/util/HashMap;
    ...
    check-cast v6, Lcom/android/settings_ex/applications/RunningState$ServiceItem;

    iget-object v6, v6, Lcom/android/settings_ex/applications/RunningState$ServiceItem;->mServiceInfo:Landroid/content/pm/ServiceInfo;
    ...
    .line 476
    iget-object v6, p0, Lcom/android/settings_ex/applications/RunningState$ProcessItem;->mPackageInfo:Landroid/content/pm/PackageItemInfo;
    ...
    iput-object v6, p0, Lcom/android/settings_ex/applications/RunningState$ProcessItem;->mDisplayLabel:Ljava/lang/CharSequence;

    .line 477
    iget-object v6, p0, Lcom/android/settings_ex/applications/RunningState$ProcessItem;->mDisplayLabel:Ljava/lang/CharSequence;

    invoke-interface {v6}, Ljava/lang/CharSequence;->toString()Ljava/lang/String;

    move-result-object v6

    iput-object v6, p0, Lcom/android/settings_ex/applications/RunningState$ProcessItem;->mLabel:Ljava/lang/String;
...
.method updateService(Landroid/content/Context;Landroid/app/ActivityManager$RunningServiceInfo;)Z
    ...
    iget-object v11, v0, Lcom/android/settings_ex/applications/RunningState$ProcessItem;->mServices:Ljava/util/HashMap;
    ...
    check-cast v10, Lcom/android/settings_ex/applications/RunningState$ServiceItem;

    .line 498
    .local v10, "si":Lcom/android/settings_ex/applications/RunningState$ServiceItem;
    if-nez v10, :cond_1
    ...
    .line 500
    new-instance v10, Lcom/android/settings_ex/applications/RunningState$ServiceItem;

    .end local v10    # "si":Lcom/android/settings_ex/applications/RunningState$ServiceItem;
    move-object/from16 v0, p0

    iget v11, v0, Lcom/android/settings_ex/applications/RunningState$ProcessItem;->mUserId:I

    invoke-direct {v10, v11}, Lcom/android/settings_ex/applications/RunningState$ServiceItem;-><init>(I)V

    .line 501
    .restart local v10    # "si":Lcom/android/settings_ex/applications/RunningState$ServiceItem;
    move-object/from16 v0, p2

    iput-object v0, v10, Lcom/android/settings_ex/applications/RunningState$ServiceItem;->mRunningService:Landroid/app/ActivityManager$RunningServiceInfo;
    ...
    iput-object v11, v10, Lcom/android/settings_ex/applications/RunningState$ServiceItem;->mServiceInfo:Landroid/content/pm/ServiceInfo;

    .line 507
    iget-object v11, v10, Lcom/android/settings_ex/applications/RunningState$ServiceItem;->mServiceInfo:Landroid/content/pm/ServiceInfo;
    ...
    .line 515
    :cond_0
    iget-object v11, v10, Lcom/android/settings_ex/applications/RunningState$ServiceItem;->mRunningService:Landroid/app/ActivityManager$RunningServiceInfo;
    ...
    iget-object v12, v10, Lcom/android/settings_ex/applications/RunningState$ServiceItem;->mServiceInfo:Landroid/content/pm/ServiceInfo;

    .line 514
    invoke-static {v9, v11, v12}, Lcom/android/settings_ex/applications/RunningState;->makeLabel(Landroid/content/pm/PackageManager;Ljava/lang/String;Landroid/content/pm/PackageItemInfo;)Ljava/lang/CharSequence;

    move-result-object v11

    iput-object v11, v10, Lcom/android/settings_ex/applications/RunningState$ServiceItem;->mDisplayLabel:Ljava/lang/CharSequence;

    .line 516
    move-object/from16 v0, p0

    iget-object v11, v0, Lcom/android/settings_ex/applications/RunningState$ProcessItem;->mDisplayLabel:Ljava/lang/CharSequence;
    ...
    iput-object v11, v0, Lcom/android/settings_ex/applications/RunningState$ProcessItem;->mLabel:Ljava/lang/String;
    ...
    iput-object v11, v10, Lcom/android/settings_ex/applications/RunningState$ServiceItem;->mPackageInfo:Landroid/content/pm/PackageItemInfo;
    ...
    iget v11, v0, Lcom/android/settings_ex/applications/RunningState$ProcessItem;->mCurSeq:I

    iput v11, v10, Lcom/android/settings_ex/applications/RunningState$ServiceItem;->mCurSeq:I
    ...
    :goto_1
    iget-wide v12, v10, Lcom/android/settings_ex/applications/RunningState$ServiceItem;->mActiveSince:J
    ...
    .line 524
    iput-wide v2, v10, Lcom/android/settings_ex/applications/RunningState$ServiceItem;->mActiveSince:J
    ...
    .line 528
    iget-boolean v11, v10, Lcom/android/settings_ex/applications/RunningState$ServiceItem;->mShownAsStarted:Z
    ...
    iput-boolean v11, v10, Lcom/android/settings_ex/applications/RunningState$ServiceItem;->mShownAsStarted:Z
    ...
    iput-object v11, v10, Lcom/android/settings_ex/applications/RunningState$ServiceItem;->mDescription:Ljava/lang/String;
    :try_end_1
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_1 .. :try_end_1} :catch_1
...
.method updateSize(Landroid/content/Context;JI)Z
    ...
    iput-wide v2, p0, Lcom/android/settings_ex/applications/RunningState$ProcessItem;->mSize:J
    ...
    .line 556
    iget-wide v2, p0, Lcom/android/settings_ex/applications/RunningState$ProcessItem;->mSize:J
