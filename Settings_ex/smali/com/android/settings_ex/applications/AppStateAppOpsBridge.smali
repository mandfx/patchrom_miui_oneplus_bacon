...
.method private getEntries()Landroid/util/SparseArray;
    ...
    iget-object v15, v0, Lcom/android/settings_ex/applications/AppStateAppOpsBridge;->mPermissions:[Ljava/lang/String;
    ...
    .line 164
    .local v2, "entries":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Landroid/util/ArrayMap<Ljava/lang/String;Lcom/android/settings_ex/applications/AppStateAppOpsBridge$PermissionState;>;>;"
    move-object/from16 v0, p0

    iget-object v14, v0, Lcom/android/settings_ex/applications/AppStateAppOpsBridge;->mProfiles:Ljava/util/List;
    ...
    .line 166
    .local v3, "entriesForProfile":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Lcom/android/settings_ex/applications/AppStateAppOpsBridge$PermissionState;>;"
    ...
    iget-object v14, v0, Lcom/android/settings_ex/applications/AppStateAppOpsBridge;->mIPackageManager:Landroid/content/pm/IPackageManager;
    ...
    invoke-direct {v0, v6}, Lcom/android/settings_ex/applications/AppStateAppOpsBridge;->shouldIgnorePackage(Ljava/lang/String;)Z
    ...
    .line 172
    new-instance v5, Lcom/android/settings_ex/applications/AppStateAppOpsBridge$PermissionState;

    invoke-direct {v5, v6, v11}, Lcom/android/settings_ex/applications/AppStateAppOpsBridge$PermissionState;-><init>(Ljava/lang/String;Landroid/os/UserHandle;)V

    .line 173
    .local v5, "newEntry":Lcom/android/settings_ex/applications/AppStateAppOpsBridge$PermissionState;
    ...
    .line 179
    .end local v2    # "entries":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Landroid/util/ArrayMap<Ljava/lang/String;Lcom/android/settings_ex/applications/AppStateAppOpsBridge$PermissionState;>;>;"
    .end local v3    # "entriesForProfile":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Lcom/android/settings_ex/applications/AppStateAppOpsBridge$PermissionState;>;"
    .end local v4    # "isAvailable":Z
    .end local v5    # "newEntry":Lcom/android/settings_ex/applications/AppStateAppOpsBridge$PermissionState;
    ...
    .restart local v2    # "entries":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Landroid/util/ArrayMap<Ljava/lang/String;Lcom/android/settings_ex/applications/AppStateAppOpsBridge$PermissionState;>;>;"
...
.method private loadAppOpsStates(Landroid/util/SparseArray;)V
    ...
    .line 226
    iget-object v8, p0, Lcom/android/settings_ex/applications/AppStateAppOpsBridge;->mAppOpsOpCodes:[I
    ...
    .line 244
    iget-object v9, p0, Lcom/android/settings_ex/applications/AppStateAppOpsBridge;->mPermissions:[Ljava/lang/String;
...
.method private loadPermissionsStates(Landroid/util/SparseArray;)V
    ...
    .local p1, "entries":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Landroid/util/ArrayMap<Ljava/lang/String;Lcom/android/settings_ex/applications/AppStateAppOpsBridge$PermissionState;>;>;"
    :try_start_0
    iget-object v10, p0, Lcom/android/settings_ex/applications/AppStateAppOpsBridge;->mProfiles:Ljava/util/List;
    ...
    .line 200
    iget-object v10, p0, Lcom/android/settings_ex/applications/AppStateAppOpsBridge;->mIPackageManager:Landroid/content/pm/IPackageManager;

    .line 201
    iget-object v11, p0, Lcom/android/settings_ex/applications/AppStateAppOpsBridge;->mPermissions:[Ljava/lang/String;
    ...
    check-cast v6, Lcom/android/settings_ex/applications/AppStateAppOpsBridge$PermissionState;

    .line 206
    .local v6, "pe":Lcom/android/settings_ex/applications/AppStateAppOpsBridge$PermissionState;
    if-eqz v6, :cond_1

    .line 207
    iput-object v3, v6, Lcom/android/settings_ex/applications/AppStateAppOpsBridge$PermissionState;->packageInfo:Landroid/content/pm/PackageInfo;

    .line 208
    const/4 v10, 0x1

    iput-boolean v10, v6, Lcom/android/settings_ex/applications/AppStateAppOpsBridge$PermissionState;->staticPermissionGranted:Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .end local v6    # "pe":Lcom/android/settings_ex/applications/AppStateAppOpsBridge$PermissionState;
    :cond_2
    const/4 v4, 0x0
...
.method public getNumPackagesAllowedByAppOps()I
    ...
    check-cast v2, Lcom/android/settings_ex/applications/AppStateAppOpsBridge$PermissionState;

    .line 291
    .local v2, "permState":Lcom/android/settings_ex/applications/AppStateAppOpsBridge$PermissionState;
    invoke-virtual {v2}, Lcom/android/settings_ex/applications/AppStateAppOpsBridge$PermissionState;->isPermissible()Z
    ...
    .line 295
    .end local v2    # "permState":Lcom/android/settings_ex/applications/AppStateAppOpsBridge$PermissionState;
    :cond_3
    return v5
.end method
...
.method public getNumPackagesDeclaredPermission()I
    ...
    .line 268
    :cond_0
    iget-object v2, p0, Lcom/android/settings_ex/applications/AppStateAppOpsBridge;->mUserManager:Landroid/os/UserManager;
...
.method public getPermissionInfo(Ljava/lang/String;I)Lcom/android/settings_ex/applications/AppStateAppOpsBridge$PermissionState;
    ...
    .line 97
    iget-object v7, v4, Lcom/android/settings_ex/applications/AppStateAppOpsBridge$PermissionState;->userHandle:Landroid/os/UserHandle;
