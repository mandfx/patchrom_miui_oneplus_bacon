...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/settings_ex/applications/AppOpsState$1;
    }
.end annotation
...
.field public static final SU_TEMPLATE:Lcom/android/settings_ex/applications/AppOpsState$OpsTemplate;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings_ex/applications/AppOpsState;->SU_TEMPLATE:Lcom/android/settings_ex/applications/AppOpsState$OpsTemplate;

    .line 233
    new-array v0, v6, [Lcom/android/settings_ex/applications/AppOpsState$OpsTemplate;
    ...
    sget-object v1, Lcom/android/settings_ex/applications/AppOpsState;->MESSAGING_TEMPLATE:Lcom/android/settings_ex/applications/AppOpsState$OpsTemplate;
    ...
    .line 235
    sget-object v1, Lcom/android/settings_ex/applications/AppOpsState;->MEDIA_TEMPLATE:Lcom/android/settings_ex/applications/AppOpsState$OpsTemplate;

    const/4 v2, 0x3

    aput-object v1, v0, v2

    sget-object v1, Lcom/android/settings_ex/applications/AppOpsState;->DEVICE_TEMPLATE:Lcom/android/settings_ex/applications/AppOpsState$OpsTemplate;

    const/4 v2, 0x4

    aput-object v1, v0, v2

    sget-object v1, Lcom/android/settings_ex/applications/AppOpsState;->BOOTUP_TEMPLATE:Lcom/android/settings_ex/applications/AppOpsState$OpsTemplate;

    const/4 v2, 0x5

    aput-object v1, v0, v2

    sget-object v1, Lcom/android/settings_ex/applications/AppOpsState;->SU_TEMPLATE:Lcom/android/settings_ex/applications/AppOpsState$OpsTemplate;
...
.method private addOp(Ljava/util/List;Landroid/app/AppOpsManager$PackageOps;Lcom/android/settings_ex/applications/AppOpsState$AppEntry;Landroid/app/AppOpsManager$OpEntry;ZI)V
    ...
    .param p3, "appEntry"    # Lcom/android/settings_ex/applications/AppOpsState$AppEntry;
...
.method public buildState(Lcom/android/settings_ex/applications/AppOpsState$OpsTemplate;)Ljava/util/List;
    .locals 2
    .param p1, "tpl"    # Lcom/android/settings_ex/applications/AppOpsState$OpsTemplate;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lcom/android/settings_ex/applications/AppOpsState$OpsTemplate;",
...
.method public buildState(Lcom/android/settings_ex/applications/AppOpsState$OpsTemplate;ILjava/lang/String;)Ljava/util/List;
    ...
    iget-object v4, v0, Lcom/android/settings_ex/applications/AppOpsState;->mContext:Landroid/content/Context;
    ...
    .line 574
    .local v5, "appEntries":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/String;Lcom/android/settings_ex/applications/AppOpsState$AppEntry;>;"
    new-instance v10, Ljava/util/ArrayList;

    invoke-direct {v10}, Ljava/util/ArrayList;-><init>()V

    .line 576
    .local v10, "entries":Ljava/util/List;, "Ljava/util/List<Lcom/android/settings_ex/applications/AppOpsState$AppOpEntry;>;"
    ...
    iget-object v3, v0, Lcom/android/settings_ex/applications/AppOpsState$OpsTemplate;->ops:[I
    ...
    iget-object v3, v0, Lcom/android/settings_ex/applications/AppOpsState$OpsTemplate;->showPerms:[Z
    ...
    iget-object v3, v0, Lcom/android/settings_ex/applications/AppOpsState;->mAppOps:Landroid/app/AppOpsManager;

    move-object/from16 v0, p1

    iget-object v6, v0, Lcom/android/settings_ex/applications/AppOpsState$OpsTemplate;->ops:[I
    ...
    invoke-direct/range {v3 .. v8}, Lcom/android/settings_ex/applications/AppOpsState;->getAppEntry(Landroid/content/Context;Ljava/util/HashMap;Ljava/lang/String;Landroid/content/pm/ApplicationInfo;Z)Lcom/android/settings_ex/applications/AppOpsState$AppEntry;

    move-result-object v12

    .line 605
    .local v12, "appEntry":Lcom/android/settings_ex/applications/AppOpsState$AppEntry;
    if-nez v12, :cond_6
    ...
    .end local v12    # "appEntry":Lcom/android/settings_ex/applications/AppOpsState$AppEntry;
    ...
    .restart local v12    # "appEntry":Lcom/android/settings_ex/applications/AppOpsState$AppEntry;
    :cond_6
    const/16 v30, 0x0
    ...
    .line 610
    invoke-direct/range {v9 .. v15}, Lcom/android/settings_ex/applications/AppOpsState;->addOp(Ljava/util/List;Landroid/app/AppOpsManager$PackageOps;Lcom/android/settings_ex/applications/AppOpsState$AppEntry;Landroid/app/AppOpsManager$OpEntry;ZI)V
    ...
    iget-object v3, v0, Lcom/android/settings_ex/applications/AppOpsState;->mPm:Landroid/content/pm/PackageManager;
    ...
    invoke-virtual {v12, v3}, Lcom/android/settings_ex/applications/AppOpsState$AppEntry;->hasOp(I)Z
    ...
    .end local v31    # "k":I
    :cond_14
    sget-object v3, Lcom/android/settings_ex/applications/AppOpsState;->APP_OP_COMPARATOR:Ljava/util/Comparator;
