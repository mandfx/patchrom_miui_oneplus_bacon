...
# direct methods
.method static synthetic -get0(Lcom/android/settings_ex/vpn2/VpnSettings;)Landroid/os/Handler;
    .locals 1
...
.method private getVpnApps()Ljava/util/List;
    ...
    iget-object v12, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mUserManager:Landroid/os/UserManager;
    ...
    invoke-virtual {p0, v12}, Lcom/android/settings_ex/vpn2/VpnSettings;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
...
.method public handleMessage(Landroid/os/Message;)Z
    ...
    iget-object v0, v0, Lcom/android/settings_ex/vpn2/VpnSettings;->mUpdater:Landroid/os/Handler;
    ...
    .line 211
    invoke-virtual/range {p0 .. p0}, Lcom/android/settings_ex/vpn2/VpnSettings;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
    ...
    iget-object v0, v0, Lcom/android/settings_ex/vpn2/VpnSettings;->mConfigPreferences:Ljava/util/HashMap;
    ...
    iget-object v0, v0, Lcom/android/settings_ex/vpn2/VpnSettings;->mAppPreferences:Ljava/util/HashMap;
    ...
    iget-object v0, v0, Lcom/android/settings_ex/vpn2/VpnSettings;->mKeyStore:Landroid/security/KeyStore;
    ...
    invoke-static/range {v18 .. v19}, Lcom/android/settings_ex/vpn2/VpnSettings;->loadVpnProfiles(Landroid/security/KeyStore;[I)Ljava/util/List;
    ...
    new-instance v11, Lcom/android/settings_ex/vpn2/ConfigPreference;
    ...
    iget-object v0, v0, Lcom/android/settings_ex/vpn2/VpnSettings;->mManageListener:Landroid/view/View$OnClickListener;
    ...
    invoke-direct {v11, v0, v1, v15}, Lcom/android/settings_ex/vpn2/ConfigPreference;-><init>(Landroid/content/Context;Landroid/view/View$OnClickListener;Lcom/android/internal/net/VpnProfile;)V

    .line 220
    .local v11, "pref":Lcom/android/settings_ex/vpn2/ConfigPreference;
    move-object/from16 v0, p0

    invoke-virtual {v11, v0}, Lcom/android/settings_ex/vpn2/ConfigPreference;->setOnPreferenceClickListener(Landroid/preference/Preference$OnPreferenceClickListener;)V
    ...
    .line 226
    .end local v11    # "pref":Lcom/android/settings_ex/vpn2/ConfigPreference;
    .end local v15    # "profile":Lcom/android/internal/net/VpnProfile;
    :cond_0
    invoke-direct/range {p0 .. p0}, Lcom/android/settings_ex/vpn2/VpnSettings;->getVpnApps()Ljava/util/List;
    ...
    invoke-static/range {v18 .. v19}, Lcom/android/settings_ex/vpn2/VpnSettings;->getVpnIdentifier(ILjava/lang/String;)Ljava/lang/String;

    move-result-object v7

    .line 228
    .local v7, "key":Ljava/lang/String;
    new-instance v10, Lcom/android/settings_ex/vpn2/AppPreference;
    ...
    invoke-direct {v10, v0, v1, v2, v3}, Lcom/android/settings_ex/vpn2/AppPreference;-><init>(Landroid/content/Context;Landroid/view/View$OnClickListener;Ljava/lang/String;I)V

    .line 230
    .local v10, "pref":Lcom/android/settings_ex/vpn2/AppPreference;
    move-object/from16 v0, p0

    invoke-virtual {v10, v0}, Lcom/android/settings_ex/vpn2/AppPreference;->setOnPreferenceClickListener(Landroid/preference/Preference$OnPreferenceClickListener;)V
    ...
    .end local v10    # "pref":Lcom/android/settings_ex/vpn2/AppPreference;
    :cond_1
    const/16 v18, 0x0
    ...
    iput-object v0, v1, Lcom/android/settings_ex/vpn2/VpnSettings;->mConnectedLegacyVpn:Lcom/android/internal/net/LegacyVpnInfo;

    .line 239
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/settings_ex/vpn2/VpnSettings;->mConnectivityService:Landroid/net/IConnectivityManager;
    ...
    check-cast v13, Lcom/android/settings_ex/vpn2/ConfigPreference;

    .line 242
    .local v13, "preference":Lcom/android/settings_ex/vpn2/ConfigPreference;
    if-eqz v13, :cond_2
    ...
    invoke-virtual {v13, v0}, Lcom/android/settings_ex/vpn2/ConfigPreference;->setState(I)V

    .line 244
    move-object/from16 v0, p0

    iput-object v6, v0, Lcom/android/settings_ex/vpn2/VpnSettings;->mConnectedLegacyVpn:Lcom/android/internal/net/LegacyVpnInfo;

    .line 249
    .end local v13    # "preference":Lcom/android/settings_ex/vpn2/ConfigPreference;
    :cond_2
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/settings_ex/vpn2/VpnSettings;->mUserManager:Landroid/os/UserManager;
    ...
    check-cast v12, Lcom/android/settings_ex/vpn2/AppPreference;

    .line 254
    .local v12, "preference":Lcom/android/settings_ex/vpn2/AppPreference;
    if-eqz v12, :cond_3
    ...
    invoke-virtual {v12, v0}, Lcom/android/settings_ex/vpn2/AppPreference;->setState(I)V
    :try_end_0
    ...
    .end local v7    # "key":Ljava/lang/String;
    .end local v12    # "preference":Lcom/android/settings_ex/vpn2/AppPreference;
...
.method public onPreferenceClick(Landroid/preference/Preference;)Z
    ...
    invoke-static {p0, v7, v10, v11}, Lcom/android/settings_ex/vpn2/ConfigDialogFragment;->show(Lcom/android/settings_ex/vpn2/VpnSettings;Lcom/android/internal/net/VpnProfile;ZZ)V
    ...
    invoke-virtual {v6}, Lcom/android/settings_ex/vpn2/AppPreference;->getUid()I
    ...
    invoke-static {p0, v4, v10, v11, v1}, Lcom/android/settings_ex/vpn2/AppDialogFragment;->show(Lcom/android/settings_ex/vpn2/VpnSettings;Landroid/content/pm/PackageInfo;Ljava/lang/String;ZZ)V
...
.method public onResume()V
    ...
    .line 163
    iget-boolean v2, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mUnavailable:Z
    ...
    .line 180
    :cond_2
    iget-object v2, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mConnectivityManager:Landroid/net/ConnectivityManager;

    sget-object v3, Lcom/android/settings_ex/vpn2/VpnSettings;->VPN_REQUEST:Landroid/net/NetworkRequest;

    iget-object v4, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mNetworkCallback:Landroid/net/ConnectivityManager$NetworkCallback;
    ...
    iput-object v2, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mUpdater:Landroid/os/Handler;
