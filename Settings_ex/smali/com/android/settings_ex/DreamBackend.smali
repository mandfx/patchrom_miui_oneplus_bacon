.class public Lcom/android/settings_ex/DreamBackend;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/settings_ex/DreamBackend$DreamInfoComparator;
    }
.end annotation
...
# instance fields
.field private final mComparator:Lcom/android/settings_ex/DreamBackend$DreamInfoComparator;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings_ex/DreamBackend;->TAG:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 83
    iput-object p1, p0, Lcom/android/settings_ex/DreamBackend;->mContext:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/android/settings_ex/DreamBackend;->mDreamManager:Landroid/service/dreams/IDreamManager;

    .line 86
    new-instance v0, Lcom/android/settings_ex/DreamBackend$DreamInfoComparator;

    invoke-virtual {p0}, Lcom/android/settings_ex/DreamBackend;->getDefaultDream()Landroid/content/ComponentName;

    move-result-object v1

    invoke-direct {v0, v1}, Lcom/android/settings_ex/DreamBackend$DreamInfoComparator;-><init>(Landroid/content/ComponentName;)V

    iput-object v0, p0, Lcom/android/settings_ex/DreamBackend;->mComparator:Lcom/android/settings_ex/DreamBackend$DreamInfoComparator;
    ...
    iput-boolean v0, p0, Lcom/android/settings_ex/DreamBackend;->mDreamsEnabledByDefault:Z
    ...
    iput-boolean v0, p0, Lcom/android/settings_ex/DreamBackend;->mDreamsActivatedOnSleepByDefault:Z
    ...
    iput-boolean v0, p0, Lcom/android/settings_ex/DreamBackend;->mDreamsActivatedOnDockByDefault:Z
...
.method private getBoolean(Ljava/lang/String;Z)Z
    ...
    .line 173
    iget-object v0, p0, Lcom/android/settings_ex/DreamBackend;->mContext:Landroid/content/Context;
...
.method private static getSettingsComponentName(Landroid/content/pm/PackageManager;Landroid/content/pm/ResolveInfo;)Landroid/content/ComponentName;
    ...
    .line 250
    sget-object v11, Lcom/android/settings_ex/DreamBackend;->TAG:Ljava/lang/String;
...
.method public getActiveDream()Landroid/content/ComponentName;
    ...
    .line 193
    iget-object v3, p0, Lcom/android/settings_ex/DreamBackend;->mDreamManager:Landroid/service/dreams/IDreamManager;
    ...
    sget-object v3, Lcom/android/settings_ex/DreamBackend;->TAG:Ljava/lang/String;
...
.method public getActiveDreamName()Ljava/lang/CharSequence;
    ...
    .line 130
    invoke-virtual {p0}, Lcom/android/settings_ex/DreamBackend;->getActiveDream()Landroid/content/ComponentName;
    ...
    .line 132
    iget-object v4, p0, Lcom/android/settings_ex/DreamBackend;->mContext:Landroid/content/Context;
...
.method public getDefaultDream()Landroid/content/ComponentName;
    ...
    .line 119
    iget-object v1, p0, Lcom/android/settings_ex/DreamBackend;->mDreamManager:Landroid/service/dreams/IDreamManager;
    ...
    sget-object v1, Lcom/android/settings_ex/DreamBackend;->TAG:Ljava/lang/String;
...
.method public getDreamInfos()Ljava/util/List;
    ...
    invoke-static {v8, v9}, Lcom/android/settings_ex/DreamBackend;->logd(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    iget-object v8, p0, Lcom/android/settings_ex/DreamBackend;->mContext:Landroid/content/Context;
    ...
    .line 103
    .local v2, "dreamInfos":Ljava/util/List;, "Ljava/util/List<Lcom/android/settings_ex/DreamBackend$DreamInfo;>;"
    ...
    .line 106
    new-instance v1, Lcom/android/settings_ex/DreamBackend$DreamInfo;

    invoke-direct {v1}, Lcom/android/settings_ex/DreamBackend$DreamInfo;-><init>()V

    .line 107
    .local v1, "dreamInfo":Lcom/android/settings_ex/DreamBackend$DreamInfo;
    ...
    iput-object v8, v1, Lcom/android/settings_ex/DreamBackend$DreamInfo;->caption:Ljava/lang/CharSequence;
    ...
    iput-object v8, v1, Lcom/android/settings_ex/DreamBackend$DreamInfo;->icon:Landroid/graphics/drawable/Drawable;

    .line 109
    invoke-static {v5}, Lcom/android/settings_ex/DreamBackend;->getDreamComponentName(Landroid/content/pm/ResolveInfo;)Landroid/content/ComponentName;

    move-result-object v8

    iput-object v8, v1, Lcom/android/settings_ex/DreamBackend$DreamInfo;->componentName:Landroid/content/ComponentName;

    .line 110
    iget-object v8, v1, Lcom/android/settings_ex/DreamBackend$DreamInfo;->componentName:Landroid/content/ComponentName;

    invoke-virtual {v8, v0}, Landroid/content/ComponentName;->equals(Ljava/lang/Object;)Z

    move-result v8

    iput-boolean v8, v1, Lcom/android/settings_ex/DreamBackend$DreamInfo;->isActive:Z

    .line 111
    invoke-static {v4, v5}, Lcom/android/settings_ex/DreamBackend;->getSettingsComponentName(Landroid/content/pm/PackageManager;Landroid/content/pm/ResolveInfo;)Landroid/content/ComponentName;

    move-result-object v8

    iput-object v8, v1, Lcom/android/settings_ex/DreamBackend$DreamInfo;->settingsComponentName:Landroid/content/ComponentName;
    ...
    .line 114
    .end local v1    # "dreamInfo":Lcom/android/settings_ex/DreamBackend$DreamInfo;
    .end local v5    # "resolveInfo":Landroid/content/pm/ResolveInfo;
    :cond_1
    iget-object v8, p0, Lcom/android/settings_ex/DreamBackend;->mComparator:Lcom/android/settings_ex/DreamBackend$DreamInfoComparator;
...
.method public isActivatedOnDock()Z
    ...
    iget-boolean v1, p0, Lcom/android/settings_ex/DreamBackend;->mDreamsActivatedOnDockByDefault:Z

    invoke-direct {p0, v0, v1}, Lcom/android/settings_ex/DreamBackend;->getBoolean(Ljava/lang/String;Z)Z
...
.method public isActivatedOnSleep()Z
    ...
    iget-boolean v1, p0, Lcom/android/settings_ex/DreamBackend;->mDreamsActivatedOnSleepByDefault:Z
...
.method public isEnabled()Z
    ...
    iget-boolean v1, p0, Lcom/android/settings_ex/DreamBackend;->mDreamsEnabledByDefault:Z
...
.method public launchSettings(Lcom/android/settings_ex/DreamBackend$DreamInfo;)V
    .locals 3
    .param p1, "dreamInfo"    # Lcom/android/settings_ex/DreamBackend$DreamInfo;
    ...
    invoke-static {v0, v1}, Lcom/android/settings_ex/DreamBackend;->logd(Ljava/lang/String;[Ljava/lang/Object;)V

    .line 206
    if-eqz p1, :cond_0

    iget-object v0, p1, Lcom/android/settings_ex/DreamBackend$DreamInfo;->settingsComponentName:Landroid/content/ComponentName;
    ...
    iget-object v2, p1, Lcom/android/settings_ex/DreamBackend$DreamInfo;->settingsComponentName:Landroid/content/ComponentName;
...
.method public setActivatedOnDock(Z)V
    ...
    invoke-direct {p0, v0, p1}, Lcom/android/settings_ex/DreamBackend;->setBoolean(Ljava/lang/String;Z)V
...
.method public setActiveDream(Landroid/content/ComponentName;)V
    ...
    invoke-static {v3, v4}, Lcom/android/settings_ex/DreamBackend;->logd(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 188
    .local v1, "e":Landroid/os/RemoteException;
    sget-object v2, Lcom/android/settings_ex/DreamBackend;->TAG:Ljava/lang/String;
...
.method public startDreaming()V
    ...
    invoke-static {v1, v2}, Lcom/android/settings_ex/DreamBackend;->logd(Ljava/lang/String;[Ljava/lang/Object;)V
