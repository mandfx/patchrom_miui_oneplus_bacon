...
.annotation system Ldalvik/annotation/Signature;
    value = {
        "Lcom/android/settings_ex/ActivityPicker;",
...
# virtual methods
.method public createItem(Landroid/content/Context;Landroid/appwidget/AppWidgetProviderInfo;Landroid/os/Bundle;)Lcom/android/settings_ex/ActivityPicker$PickAdapter$Item;
    .locals 11
    ...
    iget-object v8, p0, Lcom/android/settings_ex/AppWidgetPickActivity;->mPackageManager:Landroid/content/pm/PackageManager;
    ...
    .line 134
    :cond_0
    new-instance v4, Lcom/android/settings_ex/ActivityPicker$PickAdapter$Item;

    invoke-direct {v4, p1, v5, v2}, Lcom/android/settings_ex/ActivityPicker$PickAdapter$Item;-><init>(Landroid/content/Context;Ljava/lang/CharSequence;Landroid/graphics/drawable/Drawable;)V

    .line 135
    .local v4, "item":Lcom/android/settings_ex/ActivityPicker$PickAdapter$Item;
    ...
    iput-object v8, v4, Lcom/android/settings_ex/ActivityPicker$PickAdapter$Item;->packageName:Ljava/lang/String;
    ...
    iput-object v8, v4, Lcom/android/settings_ex/ActivityPicker$PickAdapter$Item;->className:Ljava/lang/String;

    .line 137
    iput-object p3, v4, Lcom/android/settings_ex/ActivityPicker$PickAdapter$Item;->extras:Landroid/os/Bundle;

    .line 138
    return-object v4

    .line 107
    .end local v4    # "item":Lcom/android/settings_ex/ActivityPicker$PickAdapter$Item;
...
.method public bridge synthetic createItem(Landroid/content/Context;Landroid/appwidget/AppWidgetProviderInfo;Landroid/os/Bundle;)Ljava/lang/Object;
    ...
    .prologue
    .line 96
    invoke-virtual {p0, p1, p2, p3}, Lcom/android/settings_ex/AppWidgetPickActivity;->createItem(Landroid/content/Context;Landroid/appwidget/AppWidgetProviderInfo;Landroid/os/Bundle;)Lcom/android/settings_ex/ActivityPicker$PickAdapter$Item;
...
.method protected getItems()Ljava/util/List;
    ...
    .prologue
    .line 91
    iget-object v0, p0, Lcom/android/settings_ex/AppWidgetPickActivity;->mAppWidgetLoader:Lcom/android/settings_ex/AppWidgetLoader;

    invoke-virtual {p0}, Lcom/android/settings_ex/AppWidgetPickActivity;->getIntent()Landroid/content/Intent;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/android/settings_ex/AppWidgetLoader;->getItems(Landroid/content/Intent;)Ljava/util/List;

    move-result-object v0

    iput-object v0, p0, Lcom/android/settings_ex/AppWidgetPickActivity;->mItems:Ljava/util/List;

    .line 92
    iget-object v0, p0, Lcom/android/settings_ex/AppWidgetPickActivity;->mItems:Ljava/util/List;
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    iget-object v5, p0, Lcom/android/settings_ex/AppWidgetPickActivity;->mItems:Ljava/util/List;

    invoke-interface {v5, p2}, Ljava/util/List;->get(I)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lcom/android/settings_ex/ActivityPicker$PickAdapter$Item;

    .line 150
    .local v2, "item":Lcom/android/settings_ex/ActivityPicker$PickAdapter$Item;
    iget-object v5, v2, Lcom/android/settings_ex/ActivityPicker$PickAdapter$Item;->extras:Landroid/os/Bundle;
    ...
    invoke-virtual {p0, v5, v1}, Lcom/android/settings_ex/AppWidgetPickActivity;->setResultData(ILandroid/content/Intent;)V
    ...
    :cond_1
    iget-object v5, p0, Lcom/android/settings_ex/AppWidgetPickActivity;->mAppWidgetManager:Landroid/appwidget/AppWidgetManager;

    iget v6, p0, Lcom/android/settings_ex/AppWidgetPickActivity;->mAppWidgetId:I
    ...
    .local v4, "result":I
    :goto_1
    invoke-virtual {p0, v4, v8}, Lcom/android/settings_ex/AppWidgetPickActivity;->setResultData(ILandroid/content/Intent;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 66
    new-instance v1, Lcom/android/settings_ex/AppWidgetLoader;

    .line 67
    iget-object v2, p0, Lcom/android/settings_ex/AppWidgetPickActivity;->mAppWidgetManager:Landroid/appwidget/AppWidgetManager;

    .line 66
    invoke-direct {v1, p0, v2, p0}, Lcom/android/settings_ex/AppWidgetLoader;-><init>(Landroid/content/Context;Landroid/appwidget/AppWidgetManager;Lcom/android/settings_ex/AppWidgetLoader$ItemConstructor;)V

    iput-object v1, p0, Lcom/android/settings_ex/AppWidgetPickActivity;->mAppWidgetLoader:Lcom/android/settings_ex/AppWidgetLoader;
