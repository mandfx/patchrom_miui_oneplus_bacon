...
.method public constructor <init>(Lcom/android/settings_ex/notification/SoundSettings;)V
    ...
    .line 559
    invoke-static {p1}, Lcom/android/settings_ex/notification/SoundSettings;->-get1(Lcom/android/settings_ex/notification/SoundSettings;)Lcom/android/settings_ex/notification/SoundSettings$H;
    ...
    .line 549
    iput-object v0, p0, Lcom/android/settings_ex/notification/SoundSettings$SettingsObserver;->NOTIFICATION_LIGHT_PULSE_URI:Landroid/net/Uri;
    ...
    .line 551
    iput-object v0, p0, Lcom/android/settings_ex/notification/SoundSettings$SettingsObserver;->LOCK_SCREEN_PRIVATE_URI:Landroid/net/Uri;
    ...
    .line 553
    iput-object v0, p0, Lcom/android/settings_ex/notification/SoundSettings$SettingsObserver;->LOCK_SCREEN_SHOW_URI:Landroid/net/Uri;
    ...
    .line 555
    iput-object v0, p0, Lcom/android/settings_ex/notification/SoundSettings$SettingsObserver;->VOLUME_LINK_NOTIFICATION_URI:Landroid/net/Uri;
...
.method public onChange(ZLandroid/net/Uri;)V
    ...
    .line 581
    :cond_0
    iget-object v0, p0, Lcom/android/settings_ex/notification/SoundSettings$SettingsObserver;->VOLUME_LINK_NOTIFICATION_URI:Landroid/net/Uri;
    ...
    invoke-static {v0}, Lcom/android/settings_ex/notification/SoundSettings;->-wrap3(Lcom/android/settings_ex/notification/SoundSettings;)V
...
.method public register(Z)V
    ...
    .line 566
    iget-object v1, p0, Lcom/android/settings_ex/notification/SoundSettings$SettingsObserver;->NOTIFICATION_LIGHT_PULSE_URI:Landroid/net/Uri;

    invoke-virtual {v0, v1, v2, p0}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;)V

    .line 567
    iget-object v1, p0, Lcom/android/settings_ex/notification/SoundSettings$SettingsObserver;->LOCK_SCREEN_PRIVATE_URI:Landroid/net/Uri;

    invoke-virtual {v0, v1, v2, p0}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;)V

    .line 568
    iget-object v1, p0, Lcom/android/settings_ex/notification/SoundSettings$SettingsObserver;->LOCK_SCREEN_SHOW_URI:Landroid/net/Uri;

    invoke-virtual {v0, v1, v2, p0}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;)V

    .line 569
    iget-object v1, p0, Lcom/android/settings_ex/notification/SoundSettings$SettingsObserver;->VOLUME_LINK_NOTIFICATION_URI:Landroid/net/Uri;
