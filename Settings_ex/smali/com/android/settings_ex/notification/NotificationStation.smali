...
# direct methods
.method static synthetic -get0(Lcom/android/settings_ex/notification/NotificationStation;)Ljava/lang/Runnable;
    .locals 1
...
.method static synthetic -wrap2(Lcom/android/settings_ex/notification/NotificationStation;Ljava/lang/String;)V
    .locals 0
...
.method private loadIconDrawable(Ljava/lang/String;II)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v3, p0, Lcom/android/settings_ex/notification/NotificationStation;->mFilter:Landroid/graphics/ColorFilter;
...
.method private loadNotifications()Ljava/util/List;
    ...
    iget-object v12, v0, Lcom/android/settings_ex/notification/NotificationStation;->mNoMan:Landroid/app/INotificationManager;

    .line 196
    move-object/from16 v0, p0

    iget-object v13, v0, Lcom/android/settings_ex/notification/NotificationStation;->mContext:Landroid/content/Context;
    ...
    .line 204
    .local v9, "list":Ljava/util/List;, "Ljava/util/List<Lcom/android/settings_ex/notification/NotificationStation$HistoricalNotificationInfo;>;"
    const/4 v12, 0x2
    ...
    new-instance v8, Lcom/android/settings_ex/notification/NotificationStation$HistoricalNotificationInfo;

    const/4 v12, 0x0

    invoke-direct {v8, v12}, Lcom/android/settings_ex/notification/NotificationStation$HistoricalNotificationInfo;-><init>(Lcom/android/settings_ex/notification/NotificationStation$HistoricalNotificationInfo;)V

    .line 207
    .local v8, "info":Lcom/android/settings_ex/notification/NotificationStation$HistoricalNotificationInfo;
    invoke-virtual {v11}, Landroid/service/notification/StatusBarNotification;->getPackageName()Ljava/lang/String;

    move-result-object v12

    iput-object v12, v8, Lcom/android/settings_ex/notification/NotificationStation$HistoricalNotificationInfo;->pkg:Ljava/lang/String;
    ...
    iput v12, v8, Lcom/android/settings_ex/notification/NotificationStation$HistoricalNotificationInfo;->user:I

    .line 209
    iget-object v12, v8, Lcom/android/settings_ex/notification/NotificationStation$HistoricalNotificationInfo;->pkg:Ljava/lang/String;

    iget v0, v8, Lcom/android/settings_ex/notification/NotificationStation$HistoricalNotificationInfo;->user:I
    ...
    invoke-direct {v0, v12, v1, v2}, Lcom/android/settings_ex/notification/NotificationStation;->loadIconDrawable(Ljava/lang/String;II)Landroid/graphics/drawable/Drawable;

    move-result-object v12

    iput-object v12, v8, Lcom/android/settings_ex/notification/NotificationStation$HistoricalNotificationInfo;->icon:Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {v0, v12, v1}, Lcom/android/settings_ex/notification/NotificationStation;->loadPackageIconDrawable(Ljava/lang/String;I)Landroid/graphics/drawable/Drawable;

    move-result-object v12

    iput-object v12, v8, Lcom/android/settings_ex/notification/NotificationStation$HistoricalNotificationInfo;->pkgicon:Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {v0, v12}, Lcom/android/settings_ex/notification/NotificationStation;->loadPackageName(Ljava/lang/String;)Ljava/lang/CharSequence;

    move-result-object v12

    iput-object v12, v8, Lcom/android/settings_ex/notification/NotificationStation$HistoricalNotificationInfo;->pkgname:Ljava/lang/CharSequence;
    ...
    iput-object v12, v8, Lcom/android/settings_ex/notification/NotificationStation$HistoricalNotificationInfo;->title:Ljava/lang/CharSequence;

    .line 215
    iget-object v12, v8, Lcom/android/settings_ex/notification/NotificationStation$HistoricalNotificationInfo;->title:Ljava/lang/CharSequence;

    if-eqz v12, :cond_0

    const-string/jumbo v12, ""

    iget-object v0, v8, Lcom/android/settings_ex/notification/NotificationStation$HistoricalNotificationInfo;->title:Ljava/lang/CharSequence;
    ...
    .line 225
    :cond_4
    iget-object v12, v8, Lcom/android/settings_ex/notification/NotificationStation$HistoricalNotificationInfo;->pkgname:Ljava/lang/CharSequence;
    ...
    iput-wide v0, v8, Lcom/android/settings_ex/notification/NotificationStation$HistoricalNotificationInfo;->timestamp:J
    ...
    iput v12, v8, Lcom/android/settings_ex/notification/NotificationStation$HistoricalNotificationInfo;->priority:I
    ...
    iget-wide v0, v8, Lcom/android/settings_ex/notification/NotificationStation$HistoricalNotificationInfo;->timestamp:J
    ...
    iget-object v0, v8, Lcom/android/settings_ex/notification/NotificationStation$HistoricalNotificationInfo;->pkg:Ljava/lang/String;
    ...
    invoke-static {v12, v0}, Lcom/android/settings_ex/notification/NotificationStation;->logd(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    :goto_2
    iput-boolean v12, v8, Lcom/android/settings_ex/notification/NotificationStation$HistoricalNotificationInfo;->active:Z

    .line 233
    iget v12, v8, Lcom/android/settings_ex/notification/NotificationStation$HistoricalNotificationInfo;->user:I
    ...
    .line 203
    .end local v8    # "info":Lcom/android/settings_ex/notification/NotificationStation$HistoricalNotificationInfo;
    ...
    .end local v9    # "list":Ljava/util/List;, "Ljava/util/List<Lcom/android/settings_ex/notification/NotificationStation$HistoricalNotificationInfo;>;"
    :catch_0
    move-exception v7

    .line 242
    .local v7, "e":Landroid/os/RemoteException;
    sget-object v12, Lcom/android/settings_ex/notification/NotificationStation;->TAG:Ljava/lang/String;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 138
    invoke-virtual {p0}, Lcom/android/settings_ex/notification/NotificationStation;->getResources()Landroid/content/res/Resources;
    ...
    iput-object v1, p0, Lcom/android/settings_ex/notification/NotificationStation;->mFilter:Landroid/graphics/ColorFilter;
