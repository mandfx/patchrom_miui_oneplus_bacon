...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/settings_ex/notification/ZenModeSettings$1;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0}, Lcom/android/settings_ex/notification/ZenModeSettings$1;-><init>()V
...
.method private updatePrioritySettingsSummary()V
    ...
    .line 102
    :cond_4
    iget-object v1, p0, Lcom/android/settings_ex/notification/ZenModeSettings;->mPrioritySettings:Landroid/preference/Preference;

    invoke-virtual {p0}, Lcom/android/settings_ex/notification/ZenModeSettings;->getResources()Landroid/content/res/Resources;

    move-result-object v2

    invoke-static {v2, v0}, Lcom/android/settings_ex/Utils;->join(Landroid/content/res/Resources;Ljava/util/List;)Ljava/lang/String;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v1, p0, Lcom/android/settings_ex/notification/ZenModeSettings;->mPrioritySettings:Landroid/preference/Preference;

    .line 53
    iget-object v1, p0, Lcom/android/settings_ex/notification/ZenModeSettings;->mContext:Landroid/content/Context;

    invoke-static {v1}, Lcom/android/settings_ex/notification/ZenModeSettings;->isScheduleSupported(Landroid/content/Context;)Z
    ...
    invoke-virtual {p0, v1}, Lcom/android/settings_ex/notification/ZenModeSettings;->removePreference(Ljava/lang/String;)V

    .line 57
    :cond_0
    const-string/jumbo v1, "manage_zen_access"

    invoke-virtual {p0, v1}, Lcom/android/settings_ex/notification/ZenModeSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v1

    iput-object v1, p0, Lcom/android/settings_ex/notification/ZenModeSettings;->mZenAccess:Landroid/preference/Preference;

    .line 58
    invoke-direct {p0}, Lcom/android/settings_ex/notification/ZenModeSettings;->refreshZenAccess()V
