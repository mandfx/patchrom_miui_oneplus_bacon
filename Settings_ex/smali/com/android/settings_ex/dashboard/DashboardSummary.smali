...
# direct methods
.method static synthetic -wrap0(Lcom/android/settings_ex/dashboard/DashboardSummary;Landroid/content/Context;)V
    .locals 0
...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/settings_ex/dashboard/DashboardSummary$HomePackageReceiver;-><init>(Lcom/android/settings_ex/dashboard/DashboardSummary;Lcom/android/settings_ex/dashboard/DashboardSummary$HomePackageReceiver;)V
...
.method private rebuildUI(Landroid/content/Context;)V
    ...
    .line 148
    .local v10, "categories":Ljava/util/List;, "Ljava/util/List<Lcom/android/settings_ex/dashboard/DashboardCategory;>;"
    ...
    check-cast v11, Lcom/android/settings_ex/dashboard/DashboardCategory;

    .line 153
    .local v11, "category":Lcom/android/settings_ex/dashboard/DashboardCategory;
    move-object/from16 v0, p0
    ...
    iget-object v3, v0, Lcom/android/settings_ex/dashboard/DashboardSummary;->mDashboard:Landroid/view/ViewGroup;
    ...
    invoke-virtual {v11, v4}, Lcom/android/settings_ex/dashboard/DashboardCategory;->getTitle(Landroid/content/res/Resources;)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v11}, Lcom/android/settings_ex/dashboard/DashboardCategory;->getTilesCount()I
    ...
    invoke-virtual {v11, v0}, Lcom/android/settings_ex/dashboard/DashboardCategory;->getTile(I)Lcom/android/settings_ex/dashboard/DashboardTile;
    ...
    invoke-virtual/range {v22 .. v22}, Lcom/android/settings_ex/dashboard/DashboardTileView;->getStatusTextView()Landroid/widget/TextView;

    move-result-object v8

    .line 169
    invoke-virtual/range {v22 .. v22}, Lcom/android/settings_ex/dashboard/DashboardTileView;->getSwitchView()Landroid/widget/Switch;
    ...
    .line 167
    invoke-direct/range {v2 .. v9}, Lcom/android/settings_ex/dashboard/DashboardSummary;->updateTileView(Landroid/content/Context;Landroid/content/res/Resources;Lcom/android/settings_ex/dashboard/DashboardTile;Landroid/widget/ImageView;Landroid/widget/TextView;Landroid/widget/TextView;Landroid/widget/Switch;)V
    ...
    .line 174
    invoke-static/range {p1 .. p1}, Lcom/android/settings_ex/Utils;->isAirplaneModeEnabled(Landroid/content/Context;)Z
    ...
    invoke-virtual {v0, v2}, Lcom/android/settings_ex/dashboard/DashboardTileView;->setEnabledTile(Z)V
    ...
    .line 182
    .end local v11    # "category":Lcom/android/settings_ex/dashboard/DashboardCategory;
...
.method private updateTileView(Landroid/content/Context;Landroid/content/res/Resources;Lcom/android/settings_ex/dashboard/DashboardTile;Landroid/widget/ImageView;Landroid/widget/TextView;Landroid/widget/TextView;Landroid/widget/Switch;)V
    .locals 7
    .param p1, "context"    # Landroid/content/Context;
    ...
    .line 228
    :goto_1
    iget-object v4, p3, Lcom/android/settings_ex/dashboard/DashboardTile;->switchControl:Ljava/lang/String;
...
.method public onCreateOptionsMenu(Landroid/view/Menu;Landroid/view/MenuInflater;)V
    ...
    .line 94
    invoke-virtual {p0}, Lcom/android/settings_ex/dashboard/DashboardSummary;->getClass()Ljava/lang/Class;
    ...
    invoke-static {v0, p1, v2, v1}, Lcom/android/settings_ex/HelpUtils;->prepareHelpMenuItem(Landroid/app/Activity;Landroid/view/Menu;ILjava/lang/String;)Z
