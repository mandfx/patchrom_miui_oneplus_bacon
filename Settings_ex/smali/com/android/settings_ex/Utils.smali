...
.method public static createUserSpinnerAdapter(Landroid/os/UserManager;Landroid/content/Context;)Lcom/android/settings_ex/UserAdapter;
    .locals 4
    .param p0, "userManager"    # Landroid/os/UserManager;
    .param p1, "context"    # Landroid/content/Context;
    ...
    .line 933
    invoke-static {p0, p1, v1}, Lcom/android/settings_ex/Utils;->createUserAdapter(Landroid/os/UserManager;Landroid/content/Context;Ljava/util/List;)Lcom/android/settings_ex/UserAdapter;
...
.method public static getLaunchByDeafaultSummary(Lcom/android/settings_exlib/applications/ApplicationsState$AppEntry;Landroid/hardware/usb/IUsbManager;Landroid/content/pm/PackageManager;Landroid/content/Context;)Ljava/lang/CharSequence;
    .locals 5
    ...
    invoke-static {p2, v2}, Lcom/android/settings_ex/Utils;->hasPreferredActivities(Landroid/content/pm/PackageManager;Ljava/lang/String;)Z
    ...
    .line 1264
    invoke-static {p1, v2}, Lcom/android/settings_ex/Utils;->hasUsbDefaults(Landroid/hardware/usb/IUsbManager;Ljava/lang/String;)Z
...
.method private static getSystemSignature(Landroid/content/pm/PackageManager;)Landroid/content/pm/Signature;
    ...
    invoke-static {v1}, Lcom/android/settings_ex/Utils;->getFirstSignature(Landroid/content/pm/PackageInfo;)Landroid/content/pm/Signature;
    :try_end_0
...
.method public static isSystemPackage(Landroid/content/pm/PackageManager;Landroid/content/pm/PackageInfo;)Z
    ...
    .line 1080
    sget-object v1, Lcom/android/settings_ex/Utils;->sSystemSignature:[Landroid/content/pm/Signature;
    ...
    sput-object v1, Lcom/android/settings_ex/Utils;->sSystemSignature:[Landroid/content/pm/Signature;
...
.method public static onBuildStartFragmentIntent(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;Ljava/lang/String;ILjava/lang/CharSequence;Z)Landroid/content/Intent;
    ...
    .line 871
    const-class v1, Lcom/android/settings_ex/SubSettings$SecuritySubSettings;
...
.method public static updatePreferenceToSpecificActivityFromMetaDataOrRemove(Landroid/content/Context;Landroid/preference/PreferenceGroup;Ljava/lang/String;)Z
    ...
    .line 270
    instance-of v0, v11, Lcom/android/settings_ex/IconPreferenceScreen;
    ...
    .line 292
    check-cast v5, Lcom/android/settings_ex/IconPreferenceScreen;

    .line 293
    .local v5, "iconPreference":Lcom/android/settings_ex/IconPreferenceScreen;
    invoke-virtual {v5, v4}, Lcom/android/settings_ex/IconPreferenceScreen;->setIcon(Landroid/graphics/drawable/Drawable;)V

    .line 297
    .end local v5    # "iconPreference":Lcom/android/settings_ex/IconPreferenceScreen;
    :cond_4
...
.method public static updateTileToSpecificActivityFromMetaDataOrRemove(Landroid/content/Context;Lcom/android/settings_ex/dashboard/DashboardTile;)Z
    ...
    iget-object v4, v0, Lcom/android/settings_ex/dashboard/DashboardTile;->intent:Landroid/content/Intent;
    ...
    iget-object v13, v0, Lcom/android/settings_ex/dashboard/DashboardTile;->userHandle:Ljava/util/ArrayList;
    ...
    iput v3, v0, Lcom/android/settings_ex/dashboard/DashboardTile;->iconRes:I
    ...
    iput-object v13, v0, Lcom/android/settings_ex/dashboard/DashboardTile;->iconPkg:Ljava/lang/String;

    .line 368
    :cond_5
    move-object/from16 v0, p1

    iput-object v12, v0, Lcom/android/settings_ex/dashboard/DashboardTile;->title:Ljava/lang/CharSequence;

    .line 369
    move-object/from16 v0, p1

    iput-object v11, v0, Lcom/android/settings_ex/dashboard/DashboardTile;->summary:Ljava/lang/CharSequence;
    ...
    iput-object v13, v0, Lcom/android/settings_ex/dashboard/DashboardTile;->intent:Landroid/content/Intent;
