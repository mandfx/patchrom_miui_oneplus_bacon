...
.method static synthetic -get1(Lcom/android/settings_ex/search/Index;)Ljava/util/concurrent/atomic/AtomicBoolean;
    .locals 1
...
.method static synthetic -wrap1(Lcom/android/settings_ex/search/Index;Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Landroid/provider/SearchIndexableData;Ljava/util/Map;)V
    .locals 0
...
.method private updateInternal()V
    ...
    .prologue
    .line 530
    iget-object v9, p0, Lcom/android/settings_ex/search/Index;->mDataToProcess:Lcom/android/settings_ex/search/Index$UpdateData;

    monitor-enter v9

    .line 531
    :try_start_0
    new-instance v7, Lcom/android/settings_ex/search/Index$UpdateIndexTask;

    const/4 v8, 0x0

    invoke-direct {v7, p0, v8}, Lcom/android/settings_ex/search/Index$UpdateIndexTask;-><init>(Lcom/android/settings_ex/search/Index;Lcom/android/settings_ex/search/Index$UpdateIndexTask;)V

    .line 532
    .local v7, "task":Lcom/android/settings_ex/search/Index$UpdateIndexTask;
    iget-object v8, p0, Lcom/android/settings_ex/search/Index;->mDataToProcess:Lcom/android/settings_ex/search/Index$UpdateData;

    invoke-virtual {v8}, Lcom/android/settings_ex/search/Index$UpdateData;->copy()Lcom/android/settings_ex/search/Index$UpdateData;

    move-result-object v2

    .line 533
    .local v2, "copy":Lcom/android/settings_ex/search/Index$UpdateData;
    iget-object v8, v2, Lcom/android/settings_ex/search/Index$UpdateData;->dataToUpdate:Ljava/util/List;
    ...
    invoke-static {v8}, Lcom/android/settings_ex/search/Index;->getIndexableClass(Ljava/lang/String;)Ljava/lang/Class;
    ...
    .line 539
    invoke-direct {p0, v1}, Lcom/android/settings_ex/search/Index;->getSearchIndexProvider(Ljava/lang/Class;)Lcom/android/settings_ex/search/Indexable$SearchIndexProvider;
    ...
    .line 541
    invoke-interface {v5}, Lcom/android/settings_ex/search/Indexable$SearchIndexProvider;->prepare()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 530
    .end local v2    # "copy":Lcom/android/settings_ex/search/Index$UpdateData;
    ...
    .end local v7    # "task":Lcom/android/settings_ex/search/Index$UpdateIndexTask;
    :catchall_0
    move-exception v8
    ...
    .line 537
    .restart local v2    # "copy":Lcom/android/settings_ex/search/Index$UpdateData;
    ...
    .restart local v7    # "task":Lcom/android/settings_ex/search/Index$UpdateIndexTask;
    :cond_1
    const/4 v1, 0x0
    ...
    .line 545
    .end local v3    # "data":Landroid/provider/SearchIndexableData;
    .end local v5    # "provider":Lcom/android/settings_ex/search/Indexable$SearchIndexProvider;
    .end local v6    # "sir":Landroid/provider/SearchIndexableResource;
    :cond_3
    const/4 v8, 0x1

    :try_start_1
    new-array v8, v8, [Lcom/android/settings_ex/search/Index$UpdateData;

    const/4 v10, 0x0

    aput-object v2, v8, v10

    invoke-virtual {v7, v8}, Lcom/android/settings_ex/search/Index$UpdateIndexTask;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;

    .line 546
    iget-object v8, p0, Lcom/android/settings_ex/search/Index;->mDataToProcess:Lcom/android/settings_ex/search/Index$UpdateData;

    invoke-virtual {v8}, Lcom/android/settings_ex/search/Index$UpdateData;->clear()V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
