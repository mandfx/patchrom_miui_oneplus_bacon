.class public Lcom/android/settings_ex/utils/TelephonyUtils;
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 21
    const-class v0, Lcom/android/settings_ex/utils/TelephonyUtils;

    invoke-virtual {v0}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lcom/android/settings_ex/utils/TelephonyUtils;->TAG:Ljava/lang/String;
...
.method public static getNetworkModeString(Landroid/content/Context;II)Ljava/lang/String;
    ...
    .line 37
    invoke-static {p0}, Lcom/android/settings_ex/utils/TelephonyUtils;->show4GForLTE(Landroid/content/Context;)Z

    move-result v3

    .line 38
    invoke-static {p0, p2}, Lcom/android/settings_ex/utils/TelephonyUtils;->isSupportTdscdma(Landroid/content/Context;I)Z

    move-result v4

    .line 39
    invoke-static {p0, p2}, Lcom/android/settings_ex/utils/TelephonyUtils;->isLteOnCdma(Landroid/content/Context;I)Z

    move-result v0

    invoke-static {p0, p2, v0}, Lcom/android/settings_ex/utils/TelephonyUtils;->isGlobalCDMA(Landroid/content/Context;IZ)Z

    move-result v5

    .line 40
    invoke-static {p0}, Lcom/android/settings_ex/utils/TelephonyUtils;->isWorldMode(Landroid/content/Context;)Z
    ...
    .line 34
    invoke-static/range {v0 .. v6}, Lcom/android/settings_ex/utils/TelephonyUtils;->getNetworkModeString(Landroid/content/Context;IIZZZZ)Ljava/lang/String;
...
.method public static getNetworkModeString(Landroid/content/Context;IIZZZZ)Ljava/lang/String;
    ...
    .line 117
    sget-object v3, Lcom/android/settings_ex/utils/TelephonyUtils;->TAG:Ljava/lang/String;
    ...
    .line 122
    invoke-static {p0}, Lcom/android/settings_ex/utils/TelephonyUtils;->getPhoneResources(Landroid/content/Context;)Landroid/content/res/Resources;
...
.method private static getPhoneResources(Landroid/content/Context;)Landroid/content/res/Resources;
    ...
    .line 228
    sget-object v2, Lcom/android/settings_ex/utils/TelephonyUtils;->TAG:Ljava/lang/String;
...
.method private static isWorldMode(Landroid/content/Context;)Z
    ...
    .end local v1    # "configString":Ljava/lang/String;
    :cond_4
    sget-object v6, Lcom/android/settings_ex/utils/TelephonyUtils;->TAG:Ljava/lang/String;
