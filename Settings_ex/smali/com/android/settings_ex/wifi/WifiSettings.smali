...
.method private setOffMessage()V
    ...
    .prologue
    .line 731
    iget-object v4, p0, Lcom/android/settings_ex/wifi/WifiSettings;->mEmptyView:Landroid/widget/TextView;
    ...
    invoke-virtual {p0, v4}, Lcom/android/settings_ex/wifi/WifiSettings;->getText(I)Ljava/lang/CharSequence;
    ...
    new-instance v5, Lcom/android/settings_ex/wifi/WifiSettings$5;

    invoke-direct {v5, p0}, Lcom/android/settings_ex/wifi/WifiSettings$5;-><init>(Lcom/android/settings_ex/wifi/WifiSettings;)V

    invoke-static {v4, v1, v5}, Lcom/android/settings_ex/LinkifyUtils;->linkify(Landroid/widget/TextView;Ljava/lang/StringBuilder;Lcom/android/settings_ex/LinkifyUtils$OnClickListener;)Z
...
.method private showDialog(Lcom/android/settings_exlib/wifi/AccessPoint;Z)V
    ...
    invoke-static {v9, v3}, Lcom/android/settings_ex/wifi/WifiSettings;->isEditabilityLockedDown(Landroid/content/Context;Landroid/net/wifi/WifiConfiguration;)Z
    ...
    .line 580
    const v11, 0x7f0c05d5

    invoke-virtual {p0, v11, v10}, Lcom/android/settings_ex/wifi/WifiSettings;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
...
.method public onAccessPointsChanged()V
    ...
    invoke-virtual {v3}, Lcom/android/settings_exlib/wifi/WifiTracker;->doSavedNetworksExist()Z
    ...
    :goto_1
    sput-boolean v4, Lcom/android/settings_ex/wifi/WifiSettings;->savedNetworksExist:Z
    ...
    invoke-virtual {v2}, Lcom/android/settings_exlib/wifi/WifiTracker;->getAccessPoints()Ljava/util/List;

    move-result-object v7

    .line 662
    .local v7, "accessPoints":Ljava/util/Collection;, "Ljava/util/Collection<Lcom/android/settings_exlib/wifi/AccessPoint;>;"
    invoke-virtual {p0}, Lcom/android/settings_ex/wifi/WifiSettings;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
    ...
    iget-boolean v2, v1, Lcom/android/settings_exlib/wifi/AccessPoint;->foundInScanResult:Z
    ...
    .line 674
    invoke-virtual {v1}, Lcom/android/settings_exlib/wifi/AccessPoint;->getTag()Ljava/lang/Object;
    ...
    :cond_5
    invoke-virtual {v1}, Lcom/android/settings_exlib/wifi/AccessPoint;->getDetailedState()Landroid/net/NetworkInfo$DetailedState;
    ...
    iget-object v3, p0, Lcom/android/settings_ex/wifi/WifiSettings;->mUserBadgeCache:Lcom/android/settings_ex/wifi/AccessPointPreference$UserBadgeCache;
    ...
    invoke-virtual {v0, v9}, Lcom/android/settings_ex/wifi/AccessPointPreference;->setOrder(I)V

    .line 684
    iget-object v2, p0, Lcom/android/settings_ex/wifi/WifiSettings;->mOpenSsid:Ljava/lang/String;
    ...
    .line 691
    invoke-virtual {v1, p0}, Lcom/android/settings_exlib/wifi/AccessPoint;->setListener(Lcom/android/settings_exlib/wifi/AccessPoint$AccessPointListener;)V
    ...
    invoke-virtual {p0, v2, v0}, Lcom/android/settings_ex/wifi/WifiSettings;->onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z

    .line 688
    iput-object v14, p0, Lcom/android/settings_ex/wifi/WifiSettings;->mOpenSsid:Ljava/lang/String;
    ...
    .line 695
    invoke-virtual {p0, v13}, Lcom/android/settings_ex/wifi/WifiSettings;->setProgressBarVisible(Z)V
    ...
    .line 698
    :cond_a
    invoke-virtual {p0, v4}, Lcom/android/settings_ex/wifi/WifiSettings;->setProgressBarVisible(Z)V

    goto/16 :goto_0

    .line 703
    .end local v6    # "accessPoint$iterator":Ljava/util/Iterator;
    .end local v7    # "accessPoints":Ljava/util/Collection;, "Ljava/util/Collection<Lcom/android/settings_exlib/wifi/AccessPoint;>;"
...
.method public onContextItemSelected(Landroid/view/MenuItem;)Z
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/settings_ex/wifi/WifiSettings;->showDialog(Lcom/android/settings_exlib/wifi/AccessPoint;Z)V
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 542
    sget-boolean v0, Lcom/android/settings_ex/wifi/WifiSettings;->savedNetworksExist:Z

    if-nez v0, :cond_2

    .line 543
    sput-boolean v2, Lcom/android/settings_ex/wifi/WifiSettings;->savedNetworksExist:Z
    ...
    invoke-direct {p0, v0, v2}, Lcom/android/settings_ex/wifi/WifiSettings;->showDialog(Lcom/android/settings_exlib/wifi/AccessPoint;Z)V
