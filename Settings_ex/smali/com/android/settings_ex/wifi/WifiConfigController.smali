...
.method public constructor <init>(Lcom/android/settings_ex/wifi/WifiConfigUiBase;Landroid/view/View;Lcom/android/settings_exlib/wifi/AccessPoint;ZZ)V
    ...
    invoke-virtual/range {v18 .. v18}, Lcom/android/settings_exlib/wifi/AccessPoint;->getSsid()Ljava/lang/CharSequence;
    ...
    invoke-virtual/range {v17 .. v17}, Lcom/android/settings_exlib/wifi/AccessPoint;->isSaved()Z
    ...
    invoke-virtual/range {v17 .. v17}, Lcom/android/settings_exlib/wifi/AccessPoint;->getConfig()Landroid/net/wifi/WifiConfiguration;
    ...
    invoke-direct {v0, v7, v1, v2}, Lcom/android/settings_ex/wifi/WifiConfigController;->addRow(Landroid/view/ViewGroup;ILjava/lang/String;)V
    ...
    invoke-virtual/range {v17 .. v17}, Lcom/android/settings_exlib/wifi/AccessPoint;->isActive()Z
    ...
    invoke-virtual/range {v17 .. v17}, Lcom/android/settings_exlib/wifi/AccessPoint;->getDetailedState()Landroid/net/NetworkInfo$DetailedState;
    ...
    invoke-virtual/range {v17 .. v17}, Lcom/android/settings_exlib/wifi/AccessPoint;->isEphemeral()Z
    ...
    invoke-static {v0, v14, v9, v10}, Lcom/android/settings_exlib/wifi/AccessPoint;->getSummary(Landroid/content/Context;Landroid/net/NetworkInfo$DetailedState;ZLjava/lang/String;)Ljava/lang/String;

    move-result-object v16

    .line 284
    .local v16, "summary":Ljava/lang/String;
    const v17, 0x7f0c0624
    ...
    .line 288
    const v17, 0x7f0c0623

    move-object/from16 v0, p0

    move/from16 v1, v17

    invoke-direct {v0, v7, v1, v13}, Lcom/android/settings_ex/wifi/WifiConfigController;->addRow(Landroid/view/ViewGroup;ILjava/lang/String;)V
    ...
    invoke-virtual/range {v17 .. v17}, Lcom/android/settings_exlib/wifi/AccessPoint;->getInfo()Landroid/net/wifi/WifiInfo;
    ...
    .line 311
    const v17, 0x7f0c0626

    move-object/from16 v0, p0

    move/from16 v1, v17

    invoke-direct {v0, v7, v1, v4}, Lcom/android/settings_ex/wifi/WifiConfigController;->addRow(Landroid/view/ViewGroup;ILjava/lang/String;)V
    ...
    invoke-virtual/range {v17 .. v18}, Lcom/android/settings_exlib/wifi/AccessPoint;->getSecurityString(Z)Ljava/lang/String;

    move-result-object v17

    const v18, 0x7f0c0622
...
.method private validateIpConfigFields(Landroid/net/StaticIpConfiguration;)I
    ...
    iget-object v13, v0, Lcom/android/settings_ex/wifi/WifiConfigController;->mIpAddressView:Landroid/widget/TextView;
    ...
    invoke-direct {v0, v9}, Lcom/android/settings_ex/wifi/WifiConfigController;->getIPv4Address(Ljava/lang/String;)Ljava/net/Inet4Address;
    ...
    iget-object v13, v0, Lcom/android/settings_ex/wifi/WifiConfigController;->mNetworkPrefixLengthView:Landroid/widget/TextView;
    ...
    iget-object v13, v0, Lcom/android/settings_ex/wifi/WifiConfigController;->mGatewayView:Landroid/widget/TextView;
    ...
    iget-object v13, v0, Lcom/android/settings_ex/wifi/WifiConfigController;->mDns1View:Landroid/widget/TextView;
    ...
    iget-object v14, v0, Lcom/android/settings_ex/wifi/WifiConfigController;->mConfigUi:Lcom/android/settings_ex/wifi/WifiConfigUiBase;

    invoke-interface {v14}, Lcom/android/settings_ex/wifi/WifiConfigUiBase;->getContext()Landroid/content/Context;

    move-result-object v14

    const v15, 0x7f0c0661
    ...
    iget-object v13, v0, Lcom/android/settings_ex/wifi/WifiConfigController;->mDns2View:Landroid/widget/TextView;
    ...
    invoke-direct {v0, v6}, Lcom/android/settings_ex/wifi/WifiConfigController;->getIPv4Address(Ljava/lang/String;)Ljava/net/Inet4Address;
