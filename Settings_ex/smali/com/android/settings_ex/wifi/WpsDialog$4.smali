...
.method private static synthetic -getcom_android_settings_wifi_WpsDialog$DialogStateSwitchesValues()[I
    ...
    sget-object v0, Lcom/android/settings_ex/wifi/WpsDialog$4;->-com_android_settings_wifi_WpsDialog$DialogStateSwitchesValues:[I
    ...
    :goto_2
    :try_start_3
    sget-object v1, Lcom/android/settings_ex/wifi/WpsDialog$DialogState;->WPS_INIT:Lcom/android/settings_ex/wifi/WpsDialog$DialogState;
    ...
    :goto_4
    sput-object v0, Lcom/android/settings_ex/wifi/WpsDialog$4;->-com_android_settings_wifi_WpsDialog$DialogStateSwitchesValues:[I
...
.method constructor <init>(Lcom/android/settings_ex/wifi/WpsDialog;Lcom/android/settings_ex/wifi/WpsDialog$DialogState;Ljava/lang/String;)V
    ...
    .param p2, "val$state"    # Lcom/android/settings_ex/wifi/WpsDialog$DialogState;
...
.method public run()V
    ...
    .line 240
    invoke-static {}, Lcom/android/settings_ex/wifi/WpsDialog$4;->-getcom_android_settings_wifi_WpsDialog$DialogStateSwitchesValues()[I
    ...
    invoke-static {v0}, Lcom/android/settings_ex/wifi/WpsDialog;->-get5(Lcom/android/settings_ex/wifi/WpsDialog;)Landroid/widget/TextView;
    ...
    invoke-static {v0}, Lcom/android/settings_ex/wifi/WpsDialog;->-get6(Lcom/android/settings_ex/wifi/WpsDialog;)Landroid/widget/ProgressBar;
    ...
    invoke-static {v0}, Lcom/android/settings_ex/wifi/WpsDialog;->-get3(Lcom/android/settings_ex/wifi/WpsDialog;)Landroid/widget/ProgressBar;
    ...
    invoke-static {v0}, Lcom/android/settings_ex/wifi/WpsDialog;->-get0(Lcom/android/settings_ex/wifi/WpsDialog;)Landroid/widget/Button;

    move-result-object v0

    iget-object v1, p0, Lcom/android/settings_ex/wifi/WpsDialog$4;->this$0:Lcom/android/settings_ex/wifi/WpsDialog;

    invoke-static {v1}, Lcom/android/settings_ex/wifi/WpsDialog;->-get1(Lcom/android/settings_ex/wifi/WpsDialog;)Landroid/content/Context;
    ...
    invoke-static {v0}, Lcom/android/settings_ex/wifi/WpsDialog;->-get4(Lcom/android/settings_ex/wifi/WpsDialog;)Landroid/content/BroadcastReceiver;
    ...
    invoke-static {v0}, Lcom/android/settings_ex/wifi/WpsDialog;->-get1(Lcom/android/settings_ex/wifi/WpsDialog;)Landroid/content/Context;

    move-result-object v0

    iget-object v1, p0, Lcom/android/settings_ex/wifi/WpsDialog$4;->this$0:Lcom/android/settings_ex/wifi/WpsDialog;

    invoke-static {v1}, Lcom/android/settings_ex/wifi/WpsDialog;->-get4(Lcom/android/settings_ex/wifi/WpsDialog;)Landroid/content/BroadcastReceiver;
    ...
    invoke-static {v0, v4}, Lcom/android/settings_ex/wifi/WpsDialog;->-set0(Lcom/android/settings_ex/wifi/WpsDialog;Landroid/content/BroadcastReceiver;)Landroid/content/BroadcastReceiver;
