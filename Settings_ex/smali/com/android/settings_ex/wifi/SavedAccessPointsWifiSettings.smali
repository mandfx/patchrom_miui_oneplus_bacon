...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings$2;,
        Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings$3;
    }
.end annotation
...
.field private mNetworksListView:Lcom/android/settings_ex/DraggableSortListView;
...
# direct methods
.method static synthetic -get0(Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;)Lcom/android/settings_ex/DraggableSortListView$DropListener;
    .locals 1

    iget-object v0, p0, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;->mDropListener:Lcom/android/settings_ex/DraggableSortListView$DropListener;

    return-object v0
.end method

.method static synthetic -get1(Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;)Lcom/android/settings_ex/DraggableSortListView;
    .locals 1

    iget-object v0, p0, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;->mNetworksListView:Lcom/android/settings_ex/DraggableSortListView;

    return-object v0
.end method

.method static synthetic -get2(Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;)Landroid/net/wifi/WifiManager;
    .locals 1
...
.method static synthetic -set0(Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;Z)Z
    .locals 0

    iput-boolean p1, p0, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;->mPrioritiesOrderChanged:Z

    return p1
.end method

.method static synthetic -wrap0(Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;)Z
    .locals 1

    invoke-direct {p0}, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;->isAutoConfigPriorities()Z
...
.method static synthetic -wrap1(Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;)V
    .locals 0
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 364
    new-instance v0, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings$3;

    invoke-direct {v0}, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings$3;-><init>()V
...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings$1;-><init>(Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;)V

    .line 67
    iput-object v0, p0, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;->mDropListener:Lcom/android/settings_ex/DraggableSortListView$DropListener;
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings$2;-><init>(Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;Landroid/os/Handler;)V

    iput-object v0, p0, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;->mSettingsObserver:Landroid/database/ContentObserver;
...
.method private initPreferences()V
    ...
    invoke-static {v2, v4, v5, v4}, Lcom/android/settings_exlib/wifi/WifiTracker;->getCurrentAccessPoints(Landroid/content/Context;ZZZ)Ljava/util/List;

    move-result-object v6

    .line 255
    .local v6, "accessPoints":Ljava/util/List;, "Ljava/util/List<Lcom/android/settings_exlib/wifi/AccessPoint;>;"
    new-instance v3, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings$4;

    invoke-direct {v3, p0}, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings$4;-><init>(Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;)V
    ...
    .line 276
    .local v1, "accessPoint":Lcom/android/settings_exlib/wifi/AccessPoint;
    new-instance v0, Lcom/android/settings_ex/wifi/AccessPointPreference;

    .line 277
    iget-object v3, p0, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;->mUserBadgeCache:Lcom/android/settings_ex/wifi/AccessPointPreference$UserBadgeCache;

    move v5, v4

    .line 276
    invoke-direct/range {v0 .. v5}, Lcom/android/settings_ex/wifi/AccessPointPreference;-><init>(Lcom/android/settings_exlib/wifi/AccessPoint;Landroid/content/Context;Lcom/android/settings_ex/wifi/AccessPointPreference$UserBadgeCache;ZZ)V

    .line 278
    .local v0, "preference":Lcom/android/settings_ex/wifi/AccessPointPreference;
    iget-object v3, p0, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;->mSelectedAccessPoint:Lcom/android/settings_exlib/wifi/AccessPoint;
    ...
    invoke-virtual {v3}, Lcom/android/settings_exlib/wifi/AccessPoint;->getNetworkId()I

    move-result v3

    invoke-virtual {v1}, Lcom/android/settings_exlib/wifi/AccessPoint;->getNetworkId()I
    ...
    .line 280
    iput-object v1, p0, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;->mSelectedAccessPoint:Lcom/android/settings_exlib/wifi/AccessPoint;

    .line 282
    :cond_0
    invoke-virtual {v0, v8}, Lcom/android/settings_ex/wifi/AccessPointPreference;->setOrder(I)V
    ...
    .line 286
    .end local v0    # "preference":Lcom/android/settings_ex/wifi/AccessPointPreference;
    .end local v1    # "accessPoint":Lcom/android/settings_exlib/wifi/AccessPoint;
    :cond_1
    invoke-virtual {p0}, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
...
.method private showDialog(Lcom/android/settings_ex/wifi/AccessPointPreference;Z)V
    ...
    .line 298
    :cond_0
    invoke-virtual {p1}, Lcom/android/settings_ex/wifi/AccessPointPreference;->getAccessPoint()Lcom/android/settings_exlib/wifi/AccessPoint;
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    iput-boolean v0, p0, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;->mPrioritiesOrderChanged:Z

    .line 187
    :cond_1
    invoke-virtual {p0}, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;->getListView()Landroid/widget/ListView;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;->registerForContextMenu(Landroid/view/View;)V

    .line 188
    const/4 v0, 0x1

    invoke-virtual {p0, v0}, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;->setHasOptionsMenu(Z)V
...
.method public onCreateDialog(I)Landroid/app/Dialog;
    ...
    .line 311
    iget-object v1, p0, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;->mDlgAccessPoint:Lcom/android/settings_exlib/wifi/AccessPoint;
...
.method public onCreateOptionsMenu(Landroid/view/Menu;Landroid/view/MenuInflater;)V
    ...
    .prologue
    .line 204
    invoke-virtual {p0}, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;->isUiRestricted()Z
    ...
    .line 206
    :cond_0
    invoke-virtual {p0, p1}, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;->addOptionsMenuItems(Landroid/view/Menu;)V
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    .prologue
    .line 165
    new-instance v0, Lcom/android/settings_ex/DraggableSortListView;

    invoke-virtual {p0}, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;->getActivity()Landroid/app/Activity;

    move-result-object v1

    invoke-direct {v0, v1}, Lcom/android/settings_ex/DraggableSortListView;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;->mNetworksListView:Lcom/android/settings_ex/DraggableSortListView;
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings_ex/DraggableSortListView;->setId(I)V

    .line 167
    iget-object v0, p0, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;->mNetworksListView:Lcom/android/settings_ex/DraggableSortListView;

    iget-object v1, p0, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;->mDropListener:Lcom/android/settings_ex/DraggableSortListView$DropListener;

    invoke-virtual {v0, v1}, Lcom/android/settings_ex/DraggableSortListView;->setDropListener(Lcom/android/settings_ex/DraggableSortListView$DropListener;)V
...
.method public onDetach()V
    ...
    .prologue
    .line 193
    invoke-super {p0}, Lcom/android/settings_ex/RestrictedSettingsFragment;->onDetach()V

    .line 195
    iget-boolean v0, p0, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;->mPrioritiesOrderChanged:Z
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    .line 229
    iget-object v9, p0, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;->mNetworksListView:Lcom/android/settings_ex/DraggableSortListView;
    ...
    :goto_2
    invoke-virtual {v9, v6}, Lcom/android/settings_ex/DraggableSortListView;->setDropListener(Lcom/android/settings_ex/DraggableSortListView$DropListener;)V
    ...
    .line 237
    check-cast v6, Lcom/android/settings_ex/wifi/AccessPointPreference;

    invoke-virtual {v6}, Lcom/android/settings_ex/wifi/AccessPointPreference;->getAccessPoint()Lcom/android/settings_exlib/wifi/AccessPoint;

    move-result-object v0

    .line 239
    .local v0, "ap":Lcom/android/settings_exlib/wifi/AccessPoint;
    ...
    iget-object v6, p0, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;->mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    .line 224
    .end local v0    # "ap":Lcom/android/settings_exlib/wifi/AccessPoint;
    ...
    .line 229
    :cond_3
    iget-object v6, p0, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;->mDropListener:Lcom/android/settings_ex/DraggableSortListView$DropListener;
...
.method public onPause()V
    ...
    .line 159
    invoke-virtual {p0}, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v0

    iget-object v1, p0, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;->mSettingsObserver:Landroid/database/ContentObserver;
...
.method public onResume()V
    ...
    .line 149
    iget-object v2, p0, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;->mNetworksListView:Lcom/android/settings_ex/DraggableSortListView;
    ...
    :goto_0
    invoke-virtual {v2, v1}, Lcom/android/settings_ex/DraggableSortListView;->setDropListener(Lcom/android/settings_ex/DraggableSortListView$DropListener;)V
    ...
    .line 153
    iget-object v2, p0, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;->mSettingsObserver:Landroid/database/ContentObserver;
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget-boolean v1, p0, Lcom/android/settings_ex/wifi/SavedAccessPointsWifiSettings;->mPrioritiesOrderChanged:Z
