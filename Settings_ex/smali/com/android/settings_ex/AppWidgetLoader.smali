.class public Lcom/android/settings_ex/AppWidgetLoader;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/settings_ex/AppWidgetLoader$LabelledItem;,
...
.field mItemConstructor:Lcom/android/settings_ex/AppWidgetLoader$ItemConstructor;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/android/settings_ex/AppWidgetLoader$ItemConstructor",
            "<TItem;>;"
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Landroid/appwidget/AppWidgetManager;Lcom/android/settings_ex/AppWidgetLoader$ItemConstructor;)V
    .locals 0
    ...
    .prologue
    .line 45
    .local p0, "this":Lcom/android/settings_ex/AppWidgetLoader;, "Lcom/android/settings_ex/AppWidgetLoader<TItem;>;"
    .local p3, "itemConstructor":Lcom/android/settings_ex/AppWidgetLoader$ItemConstructor;, "Lcom/android/settings_ex/AppWidgetLoader$ItemConstructor<TItem;>;"
    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    .line 47
    iput-object p1, p0, Lcom/android/settings_ex/AppWidgetLoader;->mContext:Landroid/content/Context;

    .line 48
    iput-object p2, p0, Lcom/android/settings_ex/AppWidgetLoader;->mAppWidgetManager:Landroid/appwidget/AppWidgetManager;

    .line 49
    iput-object p3, p0, Lcom/android/settings_ex/AppWidgetLoader;->mItemConstructor:Lcom/android/settings_ex/AppWidgetLoader$ItemConstructor;
...
.method protected getItems(Landroid/content/Intent;)Ljava/util/List;
    ...
    invoke-virtual {p0, v2, v0}, Lcom/android/settings_ex/AppWidgetLoader;->putInstalledAppWidgets(Ljava/util/List;I)V

    .line 157
    if-eqz v3, :cond_0

    .line 158
    invoke-virtual {p0, v2, p1}, Lcom/android/settings_ex/AppWidgetLoader;->putCustomAppWidgets(Ljava/util/List;Landroid/content/Intent;)V

    .line 160
    :cond_0
    new-instance v4, Lcom/android/settings_ex/AppWidgetLoader$1;

    invoke-direct {v4, p0}, Lcom/android/settings_ex/AppWidgetLoader$1;-><init>(Lcom/android/settings_ex/AppWidgetLoader;)V
    ...
    invoke-virtual {p0, v1, p1}, Lcom/android/settings_ex/AppWidgetLoader;->putCustomAppWidgets(Ljava/util/List;Landroid/content/Intent;)V
...
.method putAppWidgetItems(Ljava/util/List;Ljava/util/List;Ljava/util/List;IZ)V
    ...
    .line 127
    :cond_1
    iget-object v6, p0, Lcom/android/settings_ex/AppWidgetLoader;->mItemConstructor:Lcom/android/settings_ex/AppWidgetLoader$ItemConstructor;

    iget-object v7, p0, Lcom/android/settings_ex/AppWidgetLoader;->mContext:Landroid/content/Context;
    ...
    .line 127
    :goto_2
    invoke-interface {v6, v7, v1, v4}, Lcom/android/settings_ex/AppWidgetLoader$ItemConstructor;->createItem(Landroid/content/Context;Landroid/appwidget/AppWidgetProviderInfo;Landroid/os/Bundle;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lcom/android/settings_ex/AppWidgetLoader$LabelledItem;

    .line 130
    .local v2, "item":Lcom/android/settings_ex/AppWidgetLoader$LabelledItem;, "TItem;"
    invoke-interface {p3, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    goto :goto_1

    .end local v2    # "item":Lcom/android/settings_ex/AppWidgetLoader$LabelledItem;, "TItem;"
    :cond_2
    move-object v4, v5
...
.method putCustomAppWidgets(Ljava/util/List;Landroid/content/Intent;)V
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/android/settings_ex/AppWidgetLoader;->putAppWidgetItems(Ljava/util/List;Ljava/util/List;Ljava/util/List;IZ)V
...
.method putInstalledAppWidgets(Ljava/util/List;I)V
    ...
    .local p0, "this":Lcom/android/settings_ex/AppWidgetLoader;, "Lcom/android/settings_ex/AppWidgetLoader<TItem;>;"
    .local p1, "items":Ljava/util/List;, "Ljava/util/List<TItem;>;"
    iget-object v0, p0, Lcom/android/settings_ex/AppWidgetLoader;->mAppWidgetManager:Landroid/appwidget/AppWidgetManager;
