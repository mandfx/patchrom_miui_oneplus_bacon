...
# direct methods
.method public constructor <init>(Landroid/os/UserManager;Lcom/android/settings_exlib/net/UidDetailProvider;I)V
    .locals 1
    .param p1, "userManager"    # Landroid/os/UserManager;
    .param p2, "provider"    # Lcom/android/settings_exlib/net/UidDetailProvider;
    ...
    iput-object v0, p0, Lcom/android/settings_ex/DataUsageSummary$DataUsageAdapter;->mProvider:Lcom/android/settings_exlib/net/UidDetailProvider;
...
.method private accumulate(ILandroid/util/SparseArray;Landroid/net/NetworkStats$Entry;I)V
    ...
    .prologue
    .line 2007
    .local p2, "knownItems":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Lcom/android/settings_exlib/AppItem;>;"
    ...
    invoke-direct {v0, p1}, Lcom/android/settings_exlib/AppItem;-><init>(I)V

    .line 2011
    .restart local v0    # "item":Lcom/android/settings_exlib/AppItem;
    iput p4, v0, Lcom/android/settings_exlib/AppItem;->category:I
    ...
    iget-wide v4, v0, Lcom/android/settings_exlib/AppItem;->total:J
...
.method public bindStats(Landroid/net/NetworkStats;[I)V
    ...
    .line 1923
    .local v11, "knownItems":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Lcom/android/settings_exlib/AppItem;>;"
    const/4 v7, 0x0
    ...
    .line 1938
    invoke-static/range {v18 .. v18}, Lcom/android/settings_exlib/net/UidDetailProvider;->buildKeyForUser(I)I
    ...
    check-cast v10, Lcom/android/settings_exlib/AppItem;

    .line 1976
    .local v10, "item":Lcom/android/settings_exlib/AppItem;
    if-nez v10, :cond_9

    .line 1977
    new-instance v10, Lcom/android/settings_exlib/AppItem;

    .end local v10    # "item":Lcom/android/settings_exlib/AppItem;
    move/from16 v0, v17

    invoke-direct {v10, v0}, Lcom/android/settings_exlib/AppItem;-><init>(I)V

    .line 1978
    .restart local v10    # "item":Lcom/android/settings_exlib/AppItem;
    const-wide/16 v20, -0x1

    move-wide/from16 v0, v20

    iput-wide v0, v10, Lcom/android/settings_exlib/AppItem;->total:J
    ...
    .line 1980
    iget v0, v10, Lcom/android/settings_exlib/AppItem;->key:I
    ...
    iput-boolean v0, v10, Lcom/android/settings_exlib/AppItem;->restricted:Z
    ...
    .line 1986
    new-instance v16, Lcom/android/settings_exlib/AppItem;

    invoke-direct/range {v16 .. v16}, Lcom/android/settings_exlib/AppItem;-><init>()V

    .line 1987
    .local v16, "title":Lcom/android/settings_exlib/AppItem;
    const/16 v19, 0x1
    ...
    iput v0, v1, Lcom/android/settings_exlib/AppItem;->category:I
    ...
    .line 1991
    .end local v16    # "title":Lcom/android/settings_exlib/AppItem;
    :cond_b
    move-object/from16 v0, p0
...
.method public getItemViewType(I)I
    ...
    .line 2050
    iget-object v1, p0, Lcom/android/settings_ex/DataUsageSummary$DataUsageAdapter;->mItems:Ljava/util/ArrayList;
    ...
    .line 2051
    .local v0, "item":Lcom/android/settings_exlib/AppItem;
    iget v1, v0, Lcom/android/settings_exlib/AppItem;->category:I
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    check-cast v2, Lcom/android/settings_exlib/AppItem;

    .line 2074
    .local v2, "item":Lcom/android/settings_exlib/AppItem;
    ...
    iget-object v7, p0, Lcom/android/settings_ex/DataUsageSummary$DataUsageAdapter;->mProvider:Lcom/android/settings_exlib/net/UidDetailProvider;

    invoke-static {v7, v2, p2}, Lcom/android/settings_ex/DataUsageSummary$UidDetailTask;->bindView(Lcom/android/settings_exlib/net/UidDetailProvider;Lcom/android/settings_exlib/AppItem;Landroid/view/View;)V

    .line 2103
    iget-boolean v7, v2, Lcom/android/settings_exlib/AppItem;->restricted:Z

    if-eqz v7, :cond_3

    iget-wide v8, v2, Lcom/android/settings_exlib/AppItem;->total:J
