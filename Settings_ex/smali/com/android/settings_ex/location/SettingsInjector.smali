...
.method private addServiceSetting(Ljava/util/List;Lcom/android/settings_ex/location/InjectedSetting;)Landroid/preference/Preference;
    ...
    :cond_0
    new-instance v4, Lcom/android/settings_ex/DimmableIconPreference;

    iget-object v5, p0, Lcom/android/settings_ex/location/SettingsInjector;->mContext:Landroid/content/Context;

    invoke-direct {v4, v5, v1}, Lcom/android/settings_ex/DimmableIconPreference;-><init>(Landroid/content/Context;Ljava/lang/CharSequence;)V
...
.method private getSettings(Landroid/os/UserHandle;)Ljava/util/List;
    ...
    :try_start_0
    invoke-virtual {p0, v5, p1, v3}, Lcom/android/settings_ex/location/SettingsInjector;->parseServiceInfo(Landroid/content/pm/ResolveInfo;Landroid/os/UserHandle;Landroid/content/pm/PackageManager;)Lcom/android/settings_ex/location/InjectedSetting;
...
.method public getInjectedSettings(I)Ljava/util/List;
    ...
    invoke-direct {p0, v2, v5}, Lcom/android/settings_ex/location/SettingsInjector;->addServiceSetting(Ljava/util/List;Lcom/android/settings_ex/location/InjectedSetting;)Landroid/preference/Preference;
    ...
    invoke-direct {v11, p0, v5, v1, v12}, Lcom/android/settings_ex/location/SettingsInjector$Setting;-><init>(Lcom/android/settings_ex/location/SettingsInjector;Lcom/android/settings_ex/location/InjectedSetting;Landroid/preference/Preference;Lcom/android/settings_ex/location/SettingsInjector$Setting;)V
