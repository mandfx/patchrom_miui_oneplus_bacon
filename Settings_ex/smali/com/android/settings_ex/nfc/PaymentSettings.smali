...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    iget-object v7, p0, Lcom/android/settings_ex/nfc/PaymentSettings;->mPaymentBackend:Lcom/android/settings_ex/nfc/PaymentBackend;

    invoke-virtual {v7}, Lcom/android/settings_ex/nfc/PaymentBackend;->getPaymentAppInfos()Ljava/util/List;
    ...
    .line 67
    new-instance v5, Lcom/android/settings_ex/nfc/NfcPaymentPreference;

    invoke-virtual {p0}, Lcom/android/settings_ex/nfc/PaymentSettings;->getActivity()Landroid/app/Activity;

    move-result-object v7

    iget-object v8, p0, Lcom/android/settings_ex/nfc/PaymentSettings;->mPaymentBackend:Lcom/android/settings_ex/nfc/PaymentBackend;

    invoke-direct {v5, v7, v8}, Lcom/android/settings_ex/nfc/NfcPaymentPreference;-><init>(Landroid/content/Context;Lcom/android/settings_ex/nfc/PaymentBackend;)V

    .line 68
    .local v5, "preference":Lcom/android/settings_ex/nfc/NfcPaymentPreference;
    invoke-virtual {v6, v5}, Landroid/preference/PreferenceScreen;->addPreference(Landroid/preference/Preference;)Z

    .line 69
    new-instance v3, Lcom/android/settings_ex/nfc/NfcForegroundPreference;
    ...
    .line 69
    invoke-direct {v3, v7, v8}, Lcom/android/settings_ex/nfc/NfcForegroundPreference;-><init>(Landroid/content/Context;Lcom/android/settings_ex/nfc/PaymentBackend;)V

    .line 71
    .local v3, "foreground":Lcom/android/settings_ex/nfc/NfcForegroundPreference;
    invoke-virtual {v6, v3}, Landroid/preference/PreferenceScreen;->addPreference(Landroid/preference/Preference;)Z

    .line 73
    .end local v3    # "foreground":Lcom/android/settings_ex/nfc/NfcForegroundPreference;
    .end local v5    # "preference":Lcom/android/settings_ex/nfc/NfcPaymentPreference;
    :cond_0
    invoke-virtual {p0, v6}, Lcom/android/settings_ex/nfc/PaymentSettings;->setPreferenceScreen(Landroid/preference/PreferenceScreen;)V
