...
.method private buildDialog(Landroid/content/ComponentName;Ljava/lang/String;)Z
    ...
    .line 83
    .local v5, "requestedPaymentApp":Lcom/android/settings_ex/nfc/PaymentBackend$PaymentAppInfo;
    const/4 v1, 0x0

    .line 85
    .local v1, "defaultPaymentApp":Lcom/android/settings_ex/nfc/PaymentBackend$PaymentAppInfo;
    iget-object v9, p0, Lcom/android/settings_ex/nfc/PaymentDefaultDialog;->mBackend:Lcom/android/settings_ex/nfc/PaymentBackend;
    ...
    .end local v1    # "defaultPaymentApp":Lcom/android/settings_ex/nfc/PaymentBackend$PaymentAppInfo;
    .end local v5    # "requestedPaymentApp":Lcom/android/settings_ex/nfc/PaymentBackend$PaymentAppInfo;
    ...
    check-cast v6, Lcom/android/settings_ex/nfc/PaymentBackend$PaymentAppInfo;

    .line 87
    .local v6, "service":Lcom/android/settings_ex/nfc/PaymentBackend$PaymentAppInfo;
    iget-object v9, v6, Lcom/android/settings_ex/nfc/PaymentBackend$PaymentAppInfo;->componentName:Landroid/content/ComponentName;
    ...
    .line 90
    :cond_4
    iget-boolean v9, v6, Lcom/android/settings_ex/nfc/PaymentBackend$PaymentAppInfo;->isDefault:Z
    ...
    .line 95
    .end local v1    # "defaultPaymentApp":Lcom/android/settings_ex/nfc/PaymentBackend$PaymentAppInfo;
    .end local v6    # "service":Lcom/android/settings_ex/nfc/PaymentBackend$PaymentAppInfo;
    :cond_5
    if-nez v5, :cond_6
    ...
    invoke-virtual {v9}, Lcom/android/settings_ex/nfc/PaymentBackend;->getDefaultPaymentApp()Landroid/content/ComponentName;
    ...
    .line 109
    iget-object v4, p0, Lcom/android/settings_ex/nfc/PaymentDefaultDialog;->mAlertParams:Lcom/android/internal/app/AlertController$AlertParams;
    ...
    .line 114
    iget-object v10, v5, Lcom/android/settings_ex/nfc/PaymentBackend$PaymentAppInfo;->label:Ljava/lang/CharSequence;

    invoke-interface {v10}, Ljava/lang/CharSequence;->toString()Ljava/lang/String;

    move-result-object v10

    invoke-direct {p0, v10}, Lcom/android/settings_ex/nfc/PaymentDefaultDialog;->sanitizePaymentAppCaption(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 120
    iget-object v10, v1, Lcom/android/settings_ex/nfc/PaymentBackend$PaymentAppInfo;->label:Ljava/lang/CharSequence;
