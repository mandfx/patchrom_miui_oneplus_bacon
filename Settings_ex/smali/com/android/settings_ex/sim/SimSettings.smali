...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/settings_ex/sim/SimSettings$1;,
        Lcom/android/settings_ex/sim/SimSettings$2;,
        Lcom/android/settings_ex/sim/SimSettings$3;
    }
.end annotation
...
# direct methods
.method static synthetic -get0(Lcom/android/settings_ex/sim/SimSettings;)[I
    .locals 1
...
.method static synthetic -get1(Lcom/android/settings_ex/sim/SimSettings;)I
    .locals 1
...
.method static synthetic -get2(Lcom/android/settings_ex/sim/SimSettings;)Landroid/telephony/SubscriptionManager;
    .locals 1
...
.method static synthetic -get3(Lcom/android/settings_ex/sim/SimSettings;)[I
    .locals 1
...
.method static synthetic -get4(Lcom/android/settings_ex/sim/SimSettings;)Z
    .locals 1
...
.method static synthetic -set0(Lcom/android/settings_ex/sim/SimSettings;Z)Z
    .locals 0
...
.method static synthetic -wrap0(Lcom/android/settings_ex/sim/SimSettings;Landroid/telephony/SubscriptionInfo;)Ljava/lang/String;
    .locals 1
...
.method static synthetic -wrap1(Lcom/android/settings_ex/sim/SimSettings;)V
    .locals 0
...
.method static synthetic -wrap2(Lcom/android/settings_ex/sim/SimSettings;)V
    .locals 0
...
.method static synthetic -wrap3(Lcom/android/settings_ex/sim/SimSettings;)V
    .locals 0
...
.method static synthetic -wrap4(Lcom/android/settings_ex/sim/SimSettings;)V
    .locals 0
...
.method private initLTEPreference()V
    ...
    iget-object v7, p0, Lcom/android/settings_ex/sim/SimSettings;->mContext:Landroid/content/Context;
...
.method private updateSmsValues()V
    ...
    :try_start_0
    iget-object v6, p0, Lcom/android/settings_ex/sim/SimSettings;->mExtTelephony:Lcom/android/internal/telephony/IExtTelephony;
    ...
    invoke-direct {p0, v6}, Lcom/android/settings_ex/sim/SimSettings;->log(Ljava/lang/String;)V
    ...
    .line 260
    :cond_1
    iget-object v6, p0, Lcom/android/settings_ex/sim/SimSettings;->mContext:Landroid/content/Context;
    ...
    invoke-direct {p0, v6}, Lcom/android/settings_ex/sim/SimSettings;->loge(Ljava/lang/String;)V
...
.method private updateSubscriptions()V
    ...
    iput-object v7, p0, Lcom/android/settings_ex/sim/SimSettings;->mSubInfoList:Ljava/util/List;
    ...
    .local v0, "i":I
    :goto_0
    iget v7, p0, Lcom/android/settings_ex/sim/SimSettings;->mNumSlots:I

    if-ge v0, v7, :cond_1

    .line 183
    iget-object v7, p0, Lcom/android/settings_ex/sim/SimSettings;->mSimCards:Landroid/preference/PreferenceCategory;
    ...
    instance-of v7, v3, Lcom/android/settings_ex/sim/SimSettings$SimPreference;
    ...
    :cond_1
    iget-object v7, p0, Lcom/android/settings_ex/sim/SimSettings;->mMobileNetwork:Landroid/preference/PreferenceCategory;

    invoke-virtual {v7}, Landroid/preference/PreferenceCategory;->removeAll()V

    .line 189
    iget-object v7, p0, Lcom/android/settings_ex/sim/SimSettings;->mAvailableSubInfos:Ljava/util/List;

    invoke-interface {v7}, Ljava/util/List;->clear()V

    .line 190
    iget-object v7, p0, Lcom/android/settings_ex/sim/SimSettings;->mSelectableSubInfos:Ljava/util/List;
    ...
    :goto_2
    new-instance v4, Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference;

    iget-object v7, p0, Lcom/android/settings_ex/sim/SimSettings;->mContext:Landroid/content/Context;

    invoke-direct {v4, p0, v7, v5, v0}, Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference;-><init>(Lcom/android/settings_ex/sim/SimSettings;Landroid/content/Context;Landroid/telephony/SubscriptionInfo;I)V

    .line 199
    .local v4, "simPreference":Lcom/android/settings_ex/sim/SimSettings$SimPreference;
    iget v7, p0, Lcom/android/settings_ex/sim/SimSettings;->mNumSlots:I

    sub-int v7, v0, v7

    invoke-virtual {v4, v7}, Lcom/android/settings_ex/sim/SimSettings$SimPreference;->setOrder(I)V
    ...
    const v10, 0x7f0c0363

    invoke-virtual {p0, v10, v7}, Lcom/android/settings_ex/sim/SimSettings;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    .end local v4    # "simPreference":Lcom/android/settings_ex/sim/SimSettings$SimPreference;
    ...
    .restart local v4    # "simPreference":Lcom/android/settings_ex/sim/SimSettings$SimPreference;
    :cond_4
    move v7, v9
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v2, p0, Lcom/android/settings_ex/sim/SimSettings;->mMobileNetwork:Landroid/preference/PreferenceCategory;
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    invoke-static {p2}, Lcom/android/settings_ex/sim/SimSettings$SimPreference;->-wrap0(Lcom/android/settings_ex/sim/SimSettings$SimPreference;)I
