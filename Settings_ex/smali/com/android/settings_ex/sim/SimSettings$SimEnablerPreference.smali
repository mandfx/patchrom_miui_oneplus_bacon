...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference$SimEnablerDisabler;,
        Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference$1;,
        Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference$2;,
        Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference$3;
    }
.end annotation
...
# direct methods
.method static synthetic -get0(Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference;)Lcom/android/internal/telephony/IExtTelephony;
    .locals 1

    iget-object v0, p0, Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference;->mExtTelephony:Lcom/android/internal/telephony/IExtTelephony;

    return-object v0
.end method

.method static synthetic -get1(Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference;)Landroid/os/Handler;
    .locals 1
...
.method static synthetic -get2(Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference;)Z
    .locals 1

    iget-boolean v0, p0, Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference;->mIsChecked:Z

    return v0
.end method

.method static synthetic -get3(Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference;)Landroid/telephony/SubscriptionInfo;
    .locals 1

    iget-object v0, p0, Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference;->mSir:Landroid/telephony/SubscriptionInfo;

    return-object v0
.end method

.method static synthetic -set0(Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference;Z)Z
    .locals 0

    iput-boolean p1, p0, Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference;->mCmdInProgress:Z

    return p1
.end method

.method static synthetic -wrap0(Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference;Landroid/app/Dialog;)V
    .locals 0
...
.method static synthetic -wrap1(Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference;Ljava/lang/String;)V
    .locals 0
...
.method static synthetic -wrap2(Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference;Ljava/lang/String;)V
    .locals 0
    .param p1, "msg"    # Ljava/lang/String;

    .prologue
    invoke-direct {p0, p1}, Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference;->loge(Ljava/lang/String;)V

    return-void
.end method

.method static synthetic -wrap3(Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference;II)V
    .locals 0
    .param p1, "result"    # I
    .param p2, "newProvisionedState"    # I

    .prologue
    invoke-direct {p0, p1, p2}, Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference;->processSetUiccDone(II)V

    return-void
.end method

.method static synthetic -wrap4(Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference;)V
    .locals 0
...
.method static synthetic -wrap5(Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference;II)V
    .locals 0
    .param p1, "dialogId"    # I
    .param p2, "msgId"    # I
...
.method static synthetic -wrap6(Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference;)V
    .locals 0
...
.method private getProvisionStatus(I)I
    ...
    invoke-static {v0}, Lcom/android/settings_ex/sim/SimSettings;->-get3(Lcom/android/settings_ex/sim/SimSettings;)[I
...
.method private getProvisionedSlotId(Landroid/content/Context;)I
    ...
    invoke-static {v4}, Lcom/android/settings_ex/sim/SimSettings;->-get2(Lcom/android/settings_ex/sim/SimSettings;)Landroid/telephony/SubscriptionManager;
...
.method private declared-synchronized handleUserRequest()V
    ...
    invoke-static {v2}, Lcom/android/settings_ex/sim/SimSettings;->-get1(Lcom/android/settings_ex/sim/SimSettings;)I
...
.method private processSetUiccDone(II)V
    ...
    invoke-direct {p0, v1, v0, v3}, Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference;->sendMessage(ILandroid/os/Handler;I)V
...
.method private sendUiccProvisioningRequest()V
    ...
    .line 694
    :cond_0
    new-instance v0, Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference$SimEnablerDisabler;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference$SimEnablerDisabler;-><init>(Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference;Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference$SimEnablerDisabler;)V

    const/4 v1, 0x0

    new-array v1, v1, [Ljava/lang/Void;

    invoke-virtual {v0, v1}, Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference$SimEnablerDisabler;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
...
.method private showAlertDialog(II)V
    ...
    :goto_0
    invoke-static {}, Lcom/android/settings_ex/sim/SimSettings;->-get5()Landroid/app/AlertDialog;
    ...
    .line 745
    invoke-static {}, Lcom/android/settings_ex/sim/SimSettings;->-get6()Landroid/app/ProgressDialog;
    ...
    invoke-static {v4}, Lcom/android/settings_ex/sim/SimSettings;->-set1(Landroid/app/AlertDialog;)Landroid/app/AlertDialog;
    ...
    .line 758
    iget-object v6, p0, Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference;->mContext:Landroid/content/Context;

    invoke-direct {p0, v6}, Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference;->getProvisionedSlotId(Landroid/content/Context;)I
...
.method private showProgressDialog()V
    ...
    invoke-static {v2}, Lcom/android/settings_ex/sim/SimSettings;->-set2(Landroid/app/ProgressDialog;)Landroid/app/ProgressDialog;
    ...
    invoke-direct {p0, v3, v2, v4}, Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference;->sendMessage(ILandroid/os/Handler;I)V
...
.method protected onBindView(Landroid/view/View;)V
    ...
    iget v2, p0, Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference;->mSwitchVisibility:I
    ...
    .line 520
    iget-object v2, p0, Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference;->mSwitch:Landroid/widget/CompoundButton;
...
.method public update()V
    ...
    invoke-static {v4}, Lcom/android/settings_ex/sim/SimSettings;->-get3(Lcom/android/settings_ex/sim/SimSettings;)[I
    ...
    .line 531
    iget-object v6, p0, Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference;->mExtTelephony:Lcom/android/internal/telephony/IExtTelephony;
    ...
    invoke-virtual {p0, v2}, Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference;->setEnabled(Z)V
    ...
    .line 548
    iget-object v5, p0, Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference;->this$0:Lcom/android/settings_ex/sim/SimSettings;

    invoke-static {v5}, Lcom/android/settings_ex/sim/SimSettings;->-get3(Lcom/android/settings_ex/sim/SimSettings;)[I
    ...
    invoke-virtual {p0, v4}, Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference;->setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p0, v4}, Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference;->setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-direct {p0, v4}, Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference;->loge(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v4}, Lcom/android/settings_ex/sim/SimSettings$SimEnablerPreference;->setSummary(Ljava/lang/CharSequence;)V
