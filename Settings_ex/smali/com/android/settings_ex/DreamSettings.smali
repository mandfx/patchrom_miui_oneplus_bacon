...
# direct methods
.method static synthetic -get0(Lcom/android/settings_ex/DreamSettings;)Lcom/android/settings_ex/DreamBackend;
    .locals 1
...
.method private createWhenToDreamDialog()Landroid/app/Dialog;
    ...
    invoke-virtual {v2}, Lcom/android/settings_ex/DreamBackend;->isActivatedOnDock()Z
...
.method private refreshFromBackend()V
    ...
    invoke-static {v3, v5}, Lcom/android/settings_ex/DreamSettings;->logd(Ljava/lang/String;[Ljava/lang/Object;)V

    .line 267
    const/4 v3, 0x1

    iput-boolean v3, p0, Lcom/android/settings_ex/DreamSettings;->mRefreshing:Z

    .line 268
    iget-object v3, p0, Lcom/android/settings_ex/DreamSettings;->mBackend:Lcom/android/settings_ex/DreamBackend;
    ...
    invoke-virtual {v3}, Lcom/android/settings_ex/DreamSettings$DreamInfoAdapter;->clear()V
    ...
    invoke-virtual {v3}, Lcom/android/settings_ex/DreamBackend;->getDreamInfos()Ljava/util/List;

    move-result-object v0

    .line 275
    .local v0, "dreamInfos":Ljava/util/List;, "Ljava/util/List<Lcom/android/settings_ex/DreamBackend$DreamInfo;>;"
    iget-object v3, p0, Lcom/android/settings_ex/DreamSettings;->mAdapter:Lcom/android/settings_ex/DreamSettings$DreamInfoAdapter;

    invoke-virtual {v3, v0}, Lcom/android/settings_ex/DreamSettings$DreamInfoAdapter;->addAll(Ljava/util/Collection;)V

    .line 277
    .end local v0    # "dreamInfos":Ljava/util/List;, "Ljava/util/List<Lcom/android/settings_ex/DreamBackend$DreamInfo;>;"
    :cond_1
    iget-object v3, p0, Lcom/android/settings_ex/DreamSettings;->mMenuItemsWhenEnabled:[Landroid/view/MenuItem;
    ...
    :cond_2
    iput-boolean v4, p0, Lcom/android/settings_ex/DreamSettings;->mRefreshing:Z
