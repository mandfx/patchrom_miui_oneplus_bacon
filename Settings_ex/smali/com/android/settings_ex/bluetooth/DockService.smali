...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/settings_ex/bluetooth/DockService$1;,
        Lcom/android/settings_ex/bluetooth/DockService$2;,
        Lcom/android/settings_ex/bluetooth/DockService$3;,
        Lcom/android/settings_ex/bluetooth/DockService$4;
    }
.end annotation
...
# direct methods
.method static synthetic -get0(Lcom/android/settings_ex/bluetooth/DockService;)Landroid/widget/CheckBox;
    .locals 1
...
.method static synthetic -get1(Lcom/android/settings_ex/bluetooth/DockService;)[Z
    .locals 1
...
.method static synthetic -get2(Lcom/android/settings_ex/bluetooth/DockService;)Landroid/bluetooth/BluetoothDevice;
    .locals 1
...
.method static synthetic -get3(Lcom/android/settings_ex/bluetooth/DockService;)Landroid/bluetooth/BluetoothDevice;
    .locals 1
...
.method static synthetic -get4(Lcom/android/settings_ex/bluetooth/DockService;)I
    .locals 1
...
.method static synthetic -wrap0(Lcom/android/settings_ex/bluetooth/DockService;Landroid/bluetooth/BluetoothDevice;I)V
    .locals 0
...
.method static synthetic -wrap1(Lcom/android/settings_ex/bluetooth/DockService;Landroid/bluetooth/BluetoothDevice;II)V
    .locals 0
    .param p1, "device"    # Landroid/bluetooth/BluetoothDevice;
    .param p2, "state"    # I
    .param p3, "startId"    # I
...
.method static synthetic -wrap2(Lcom/android/settings_ex/bluetooth/DockService;Landroid/os/Message;)V
    .locals 0
...
.method public constructor <init>()V
    ...
    .line 570
    new-instance v0, Lcom/android/settings_ex/bluetooth/DockService$1;

    invoke-direct {v0, p0}, Lcom/android/settings_ex/bluetooth/DockService$1;-><init>(Lcom/android/settings_ex/bluetooth/DockService;)V
...
.method private declared-synchronized applyBtSettings(Landroid/bluetooth/BluetoothDevice;I)V
    ...
    :try_start_0
    iget-object v8, p0, Lcom/android/settings_ex/bluetooth/DockService;->mProfiles:[Lcom/android/settings_exlib/bluetooth/LocalBluetoothProfile;
    :try_end_0
    ...
    :cond_1
    :try_start_1
    iget-object v8, p0, Lcom/android/settings_ex/bluetooth/DockService;->mCheckedItems:[Z

    if-eqz v8, :cond_0

    .line 817
    iget-object v8, p0, Lcom/android/settings_ex/bluetooth/DockService;->mLocalAdapter:Lcom/android/settings_exlib/bluetooth/LocalBluetoothAdapter;
    ...
    .line 834
    iget-object v7, p0, Lcom/android/settings_ex/bluetooth/DockService;->mPendingDevice:Landroid/bluetooth/BluetoothDevice;

    if-eqz v7, :cond_2

    iget-object v7, p0, Lcom/android/settings_ex/bluetooth/DockService;->mPendingDevice:Landroid/bluetooth/BluetoothDevice;

    iget-object v8, p0, Lcom/android/settings_ex/bluetooth/DockService;->mDevice:Landroid/bluetooth/BluetoothDevice;
    ...
    :try_start_3
    iput-object v7, p0, Lcom/android/settings_ex/bluetooth/DockService;->mPendingDevice:Landroid/bluetooth/BluetoothDevice;
    ...
    .local v4, "i":I
    :goto_1
    iget-object v7, p0, Lcom/android/settings_ex/bluetooth/DockService;->mProfiles:[Lcom/android/settings_exlib/bluetooth/LocalBluetoothProfile;
    ...
    .line 858
    .local v5, "profile":Lcom/android/settings_exlib/bluetooth/LocalBluetoothProfile;
    iget-object v7, p0, Lcom/android/settings_ex/bluetooth/DockService;->mCheckedItems:[Z
    ...
    invoke-interface {v5, p1, v7}, Lcom/android/settings_exlib/bluetooth/LocalBluetoothProfile;->setPreferred(Landroid/bluetooth/BluetoothDevice;Z)V
    ...
    invoke-interface {v5, v7}, Lcom/android/settings_exlib/bluetooth/LocalBluetoothProfile;->getConnectionStatus(Landroid/bluetooth/BluetoothDevice;)I
    ...
    invoke-virtual {v1, v7}, Lcom/android/settings_exlib/bluetooth/CachedBluetoothDevice;->disconnect(Lcom/android/settings_exlib/bluetooth/LocalBluetoothProfile;)V
    :try_end_3
    ...
    .end local v4    # "i":I
    .end local v5    # "profile":Lcom/android/settings_exlib/bluetooth/LocalBluetoothProfile;
    ...
    .line 877
    .restart local v1    # "cachedDevice":Lcom/android/settings_exlib/bluetooth/CachedBluetoothDevice;
    ...
    :try_start_4
    invoke-virtual {v1, v7}, Lcom/android/settings_exlib/bluetooth/CachedBluetoothDevice;->connect(Z)V
    :try_end_4
...
.method private declared-synchronized connectIfEnabled(Landroid/bluetooth/BluetoothDevice;)V
    ...
    invoke-interface {v1, p1}, Lcom/android/settings_exlib/bluetooth/LocalBluetoothProfile;->getPreferred(Landroid/bluetooth/BluetoothDevice;)I
...
.method private createDialog(Landroid/bluetooth/BluetoothDevice;II)V
    ...
    .prologue
    .line 490
    iget-object v4, p0, Lcom/android/settings_ex/bluetooth/DockService;->mDialog:Landroid/app/AlertDialog;
    ...
    iput-object v4, p0, Lcom/android/settings_ex/bluetooth/DockService;->mDialog:Landroid/app/AlertDialog;
    ...
    invoke-virtual {p0, v6, v4}, Lcom/android/settings_ex/bluetooth/DockService;->startForeground(ILandroid/app/Notification;)V
...
.method private handleBluetoothStateOn(I)V
    ...
    .line 739
    :cond_0
    iput-object v6, p0, Lcom/android/settings_ex/bluetooth/DockService;->mPendingDevice:Landroid/bluetooth/BluetoothDevice;
    ...
    invoke-virtual {p0, v6, v4}, Lcom/android/settings_ex/bluetooth/DockService;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
...
.method private declared-synchronized handleUnexpectedDisconnect(Landroid/bluetooth/BluetoothDevice;Lcom/android/settings_exlib/bluetooth/LocalBluetoothProfile;I)V
    ...
    invoke-virtual {p0, v5, v4}, Lcom/android/settings_ex/bluetooth/DockService;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
...
.method private msgTypeDisableBluetooth(I)Z
    ...
    invoke-virtual {v1}, Lcom/android/settings_exlib/bluetooth/LocalBluetoothAdapter;->disable()Z
...
.method private msgTypeDocked(Landroid/bluetooth/BluetoothDevice;II)Z
    ...
    invoke-virtual {v2, v3}, Lcom/android/settings_ex/bluetooth/DockService$ServiceHandler;->removeMessages(I)V
    ...
    .line 386
    iget-object v2, p0, Lcom/android/settings_ex/bluetooth/DockService;->mDevice:Landroid/bluetooth/BluetoothDevice;
    ...
    invoke-direct {p0, v2}, Lcom/android/settings_ex/bluetooth/DockService;->handleUndocked(Landroid/bluetooth/BluetoothDevice;)V
    ...
    invoke-virtual {v2, p0}, Lcom/android/settings_exlib/bluetooth/LocalBluetoothProfileManager;->addServiceListener(Lcom/android/settings_exlib/bluetooth/LocalBluetoothProfileManager$ServiceListener;)V

    .line 398
    iget-object v2, p0, Lcom/android/settings_ex/bluetooth/DockService;->mProfileManager:Lcom/android/settings_exlib/bluetooth/LocalBluetoothProfileManager;

    invoke-virtual {v2}, Lcom/android/settings_exlib/bluetooth/LocalBluetoothProfileManager;->isManagerReady()Z
    ...
    new-instance v2, Lcom/android/settings_ex/bluetooth/DockService$5;

    invoke-direct {v2, p0, v0, p2, p3}, Lcom/android/settings_ex/bluetooth/DockService$5;-><init>(Lcom/android/settings_ex/bluetooth/DockService;Landroid/bluetooth/BluetoothDevice;II)V
    ...
    .line 419
    invoke-direct {p0, v4, p2, p3}, Lcom/android/settings_ex/bluetooth/DockService;->handleDocked(Landroid/bluetooth/BluetoothDevice;II)V
...
.method private msgTypeUndockedPermanent(Landroid/bluetooth/BluetoothDevice;I)Z
    ...
    .line 359
    invoke-virtual {v2, v3, v4, p2, v5}, Lcom/android/settings_ex/bluetooth/DockService$ServiceHandler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
...
.method declared-synchronized hasOtherConnectedDevices(Landroid/bluetooth/BluetoothDevice;)Z
    ...
    .line 427
    :try_start_0
    iget-object v5, p0, Lcom/android/settings_ex/bluetooth/DockService;->mDeviceManager:Lcom/android/settings_exlib/bluetooth/CachedBluetoothDeviceManager;
    ...
    iget-object v5, p0, Lcom/android/settings_ex/bluetooth/DockService;->mLocalAdapter:Lcom/android/settings_exlib/bluetooth/LocalBluetoothAdapter;
...
.method public onCreate()V
    ...
    invoke-direct {v2, p0, v3, v4}, Lcom/android/settings_ex/bluetooth/DockService$ServiceHandler;-><init>(Lcom/android/settings_ex/bluetooth/DockService;Landroid/os/Looper;Lcom/android/settings_ex/bluetooth/DockService$ServiceHandler;)V
...
.method public onDestroy()V
    ...
    .line 173
    :cond_2
    iput-object v1, p0, Lcom/android/settings_ex/bluetooth/DockService;->mLocalAdapter:Lcom/android/settings_exlib/bluetooth/LocalBluetoothAdapter;

    .line 174
    iput-object v1, p0, Lcom/android/settings_ex/bluetooth/DockService;->mDeviceManager:Lcom/android/settings_exlib/bluetooth/CachedBluetoothDeviceManager;

    .line 175
    iput-object v1, p0, Lcom/android/settings_ex/bluetooth/DockService;->mProfileManager:Lcom/android/settings_exlib/bluetooth/LocalBluetoothProfileManager;
