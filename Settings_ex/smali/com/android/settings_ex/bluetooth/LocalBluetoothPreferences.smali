...
.method static shouldShowDialogInForeground(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .prologue
    .line 67
    invoke-static/range {p0 .. p0}, Lcom/android/settings_ex/bluetooth/Utils;->getLocalBtManager(Landroid/content/Context;)Lcom/android/settings_exlib/bluetooth/LocalBluetoothManager;

    move-result-object v10

    .line 68
    .local v10, "manager":Lcom/android/settings_exlib/bluetooth/LocalBluetoothManager;
    if-nez v10, :cond_0
    ...
    .line 74
    :cond_0
    invoke-virtual {v10}, Lcom/android/settings_exlib/bluetooth/LocalBluetoothManager;->isForegroundActivity()Z
    ...
    invoke-static/range {p0 .. p0}, Lcom/android/settings_ex/bluetooth/LocalBluetoothPreferences;->getSharedPreferences(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    .line 97
    :cond_3
    invoke-virtual {v10}, Lcom/android/settings_exlib/bluetooth/LocalBluetoothManager;->getBluetoothAdapter()Lcom/android/settings_exlib/bluetooth/LocalBluetoothAdapter;

    move-result-object v2

    .line 98
    .local v2, "adapter":Lcom/android/settings_exlib/bluetooth/LocalBluetoothAdapter;
    if-eqz v2, :cond_4

    invoke-virtual {v2}, Lcom/android/settings_exlib/bluetooth/LocalBluetoothAdapter;->isDiscovering()Z
