.class public Lcom/android/settings_ex/cmstats/StatsUploadJobService;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/settings_ex/cmstats/StatsUploadJobService$StatsUploadTask;
    }
.end annotation
...
.method static synthetic -get0()Z
    ...
    sget-boolean v0, Lcom/android/settings_ex/cmstats/StatsUploadJobService;->DEBUG:Z
...
.method static synthetic -get1()Ljava/lang/String;
    ...
    sget-object v0, Lcom/android/settings_ex/cmstats/StatsUploadJobService;->TAG:Ljava/lang/String;

    return-object v0
.end method

.method static synthetic -get2(Lcom/android/settings_ex/cmstats/StatsUploadJobService;)Ljava/util/Map;
    .locals 1

    iget-object v0, p0, Lcom/android/settings_ex/cmstats/StatsUploadJobService;->mCurrentJobs:Ljava/util/Map;

    return-object v0
.end method

.method static synthetic -wrap0(Lcom/android/settings_ex/cmstats/StatsUploadJobService;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)Z
    .locals 1
    ...
    .prologue
    invoke-direct/range {p0 .. p7}, Lcom/android/settings_ex/cmstats/StatsUploadJobService;->uploadToCM(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)Z
...
.method static synthetic -wrap1(Lcom/android/settings_ex/cmstats/StatsUploadJobService;Lorg/json/JSONObject;)Z
    .locals 1
    .param p1, "json"    # Lorg/json/JSONObject;

    .prologue
    invoke-direct {p0, p1}, Lcom/android/settings_ex/cmstats/StatsUploadJobService;->uploadToCyanogen(Lorg/json/JSONObject;)Z
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 45
    const-class v0, Lcom/android/settings_ex/cmstats/StatsUploadJobService;

    invoke-virtual {v0}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lcom/android/settings_ex/cmstats/StatsUploadJobService;->TAG:Ljava/lang/String;
    ...
    sput-boolean v0, Lcom/android/settings_ex/cmstats/StatsUploadJobService;->DEBUG:Z
...
.method public constructor <init>()V
    ...
    .line 61
    iput-object v0, p0, Lcom/android/settings_ex/cmstats/StatsUploadJobService;->mCurrentJobs:Ljava/util/Map;
...
.method private getAuthToken()Ljava/lang/String;
    ...
    invoke-virtual {p0, v7}, Lcom/android/settings_ex/cmstats/StatsUploadJobService;->getString(I)Ljava/lang/String;
    ...
    .local v4, "success":Z
    :goto_0
    sget-boolean v7, Lcom/android/settings_ex/cmstats/StatsUploadJobService;->DEBUG:Z

    if-eqz v7, :cond_0

    sget-object v7, Lcom/android/settings_ex/cmstats/StatsUploadJobService;->TAG:Ljava/lang/String;
    ...
    :goto_1
    invoke-direct {p0, v6, v7}, Lcom/android/settings_ex/cmstats/StatsUploadJobService;->getResponse(Ljava/net/HttpURLConnection;Z)Ljava/lang/String;
...
.method private uploadToCM(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-virtual {p0, v5}, Lcom/android/settings_ex/cmstats/StatsUploadJobService;->getString(I)Ljava/lang/String;
    ...
    sget-boolean v5, Lcom/android/settings_ex/cmstats/StatsUploadJobService;->DEBUG:Z

    if-eqz v5, :cond_0

    sget-object v5, Lcom/android/settings_ex/cmstats/StatsUploadJobService;->TAG:Ljava/lang/String;
    ...
    .line 185
    sget-object v6, Lcom/android/settings_ex/cmstats/StatsUploadJobService;->TAG:Ljava/lang/String;
    ...
    .line 185
    :goto_2
    invoke-direct {p0, v4, v5}, Lcom/android/settings_ex/cmstats/StatsUploadJobService;->getResponse(Ljava/net/HttpURLConnection;Z)Ljava/lang/String;
...
.method private uploadToCyanogen(Lorg/json/JSONObject;)Z
    ...
    .line 197
    invoke-direct {p0}, Lcom/android/settings_ex/cmstats/StatsUploadJobService;->getAuthToken()Ljava/lang/String;
    ...
    .line 200
    sget-object v9, Lcom/android/settings_ex/cmstats/StatsUploadJobService;->TAG:Ljava/lang/String;
    ...
    invoke-virtual {p0, v9}, Lcom/android/settings_ex/cmstats/StatsUploadJobService;->getString(I)Ljava/lang/String;
    ...
    :cond_1
    invoke-direct {p0, v6, v8}, Lcom/android/settings_ex/cmstats/StatsUploadJobService;->getResponse(Ljava/net/HttpURLConnection;Z)Ljava/lang/String;

    move-result-object v2

    .line 227
    .local v2, "response":Ljava/lang/String;
    sget-boolean v8, Lcom/android/settings_ex/cmstats/StatsUploadJobService;->DEBUG:Z

    if-eqz v8, :cond_2

    .line 228
    sget-object v8, Lcom/android/settings_ex/cmstats/StatsUploadJobService;->TAG:Ljava/lang/String;
...
.method public onStartJob(Landroid/app/job/JobParameters;)Z
    ...
    .line 66
    sget-boolean v1, Lcom/android/settings_ex/cmstats/StatsUploadJobService;->DEBUG:Z

    if-eqz v1, :cond_0

    .line 67
    sget-object v1, Lcom/android/settings_ex/cmstats/StatsUploadJobService;->TAG:Ljava/lang/String;
    ...
    .line 68
    :cond_0
    new-instance v0, Lcom/android/settings_ex/cmstats/StatsUploadJobService$StatsUploadTask;

    invoke-direct {v0, p0, p1}, Lcom/android/settings_ex/cmstats/StatsUploadJobService$StatsUploadTask;-><init>(Lcom/android/settings_ex/cmstats/StatsUploadJobService;Landroid/app/job/JobParameters;)V

    .line 69
    .local v0, "uploadTask":Lcom/android/settings_ex/cmstats/StatsUploadJobService$StatsUploadTask;
    iget-object v1, p0, Lcom/android/settings_ex/cmstats/StatsUploadJobService;->mCurrentJobs:Ljava/util/Map;
    ...
    invoke-virtual {v0, v2}, Lcom/android/settings_ex/cmstats/StatsUploadJobService$StatsUploadTask;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
...
.method public onStopJob(Landroid/app/job/JobParameters;)Z
    ...
    check-cast v0, Lcom/android/settings_ex/cmstats/StatsUploadJobService$StatsUploadTask;

    .line 82
    .local v0, "cancelledJob":Lcom/android/settings_ex/cmstats/StatsUploadJobService$StatsUploadTask;
    if-eqz v0, :cond_1

    .line 84
    invoke-virtual {v0, v4}, Lcom/android/settings_ex/cmstats/StatsUploadJobService$StatsUploadTask;->cancel(Z)Z
