.class public Lcom/android/settings_exlib/net/UidDetailProvider;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/settings_exlib/net/UidDetailProvider;->mContext:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/android/settings_exlib/net/UidDetailProvider;->mUidDetailCache:Landroid/util/SparseArray;
...
.method private buildUidDetail(I)Lcom/android/settings_exlib/net/UidDetail;
    .locals 25
    .param p1, "uid"    # I
    ...
    iget-object v0, v0, Lcom/android/settings_exlib/net/UidDetailProvider;->mContext:Landroid/content/Context;
    ...
    new-instance v5, Lcom/android/settings_exlib/net/UidDetail;

    invoke-direct {v5}, Lcom/android/settings_exlib/net/UidDetail;-><init>()V

    .line 109
    .local v5, "detail":Lcom/android/settings_exlib/net/UidDetail;
    ...
    iput-object v0, v5, Lcom/android/settings_exlib/net/UidDetail;->label:Ljava/lang/CharSequence;
    ...
    iput-object v0, v5, Lcom/android/settings_exlib/net/UidDetail;->icon:Landroid/graphics/drawable/Drawable;
    ...
    invoke-static/range {p1 .. p1}, Lcom/android/settings_exlib/net/UidDetailProvider;->isKeyForUser(I)Z
    ...
    .line 136
    invoke-static/range {p1 .. p1}, Lcom/android/settings_exlib/net/UidDetailProvider;->getUserIdForKey(I)I
    ...
    invoke-static {v0, v10}, Lcom/android/settings_exlib/Utils;->getUserLabel(Landroid/content/Context;Landroid/content/pm/UserInfo;)Ljava/lang/String;
    ...
    invoke-static {v0, v1, v10}, Lcom/android/settings_exlib/Utils;->getUserIcon(Landroid/content/Context;Landroid/os/UserManager;Landroid/content/pm/UserInfo;)Landroid/graphics/drawable/Drawable;
    ...
    :sswitch_0
    sget v22, Lcom/android/settings_exlib/R$string;->process_kernel_label:I
    ...
    .line 120
    sget v22, Lcom/android/settings_exlib/R$string;->data_usage_uninstalled_apps_users:I
    ...
    .line 121
    :cond_0
    sget v22, Lcom/android/settings_exlib/R$string;->data_usage_uninstalled_apps:I
    ...
    invoke-static {v4}, Lcom/android/settings_exlib/Utils;->getTetheringLabel(Landroid/net/ConnectivityManager;)I
    ...
    :cond_2
    iget-object v0, v5, Lcom/android/settings_exlib/net/UidDetail;->label:Ljava/lang/CharSequence;
    ...
    iput-object v0, v5, Lcom/android/settings_exlib/net/UidDetail;->contentDescription:Ljava/lang/CharSequence;
    :try_end_0
    ...
    iput-object v0, v5, Lcom/android/settings_exlib/net/UidDetail;->detailLabels:[Ljava/lang/CharSequence;
    ...
    iput-object v0, v5, Lcom/android/settings_exlib/net/UidDetail;->detailContentDescriptions:[Ljava/lang/CharSequence;
    ...
    .line 170
    iget-object v0, v5, Lcom/android/settings_exlib/net/UidDetail;->detailLabels:[Ljava/lang/CharSequence;
    ...
    .line 171
    iget-object v0, v5, Lcom/android/settings_exlib/net/UidDetail;->detailContentDescriptions:[Ljava/lang/CharSequence;
...
.method public clearCache()V
    ...
    .prologue
    .line 70
    iget-object v1, p0, Lcom/android/settings_exlib/net/UidDetailProvider;->mUidDetailCache:Landroid/util/SparseArray;

    monitor-enter v1

    .line 71
    :try_start_0
    iget-object v0, p0, Lcom/android/settings_exlib/net/UidDetailProvider;->mUidDetailCache:Landroid/util/SparseArray;
...
.method public getUidDetail(IZ)Lcom/android/settings_exlib/net/UidDetail;
    .locals 4
    .param p1, "uid"    # I
    .param p2, "blocking"    # Z
    ...
    .line 81
    iget-object v2, p0, Lcom/android/settings_exlib/net/UidDetailProvider;->mUidDetailCache:Landroid/util/SparseArray;
    ...
    check-cast v0, Lcom/android/settings_exlib/net/UidDetail;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 81
    .end local v0    # "detail":Lcom/android/settings_exlib/net/UidDetail;
    :catchall_0
    move-exception v1
    ...
    .line 87
    .restart local v0    # "detail":Lcom/android/settings_exlib/net/UidDetail;
    :cond_0
    if-nez p2, :cond_1
    ...
    .line 91
    :cond_1
    invoke-direct {p0, p1}, Lcom/android/settings_exlib/net/UidDetailProvider;->buildUidDetail(I)Lcom/android/settings_exlib/net/UidDetail;
