...
.method private loadInBackground(Landroid/net/NetworkTemplate;Lcom/android/settings_exlib/AppItem;I)Lcom/android/settings_exlib/net/ChartData;
    ...
    iget-object v4, p0, Lcom/android/settings_exlib/net/ChartDataLoader;->mSession:Landroid/net/INetworkStatsSession;
    ...
    iput-object v4, v0, Lcom/android/settings_exlib/net/ChartData;->network:Landroid/net/NetworkStatsHistory;

    .line 91
    if-eqz p2, :cond_1

    .line 93
    iget-object v4, p2, Lcom/android/settings_exlib/AppItem;->uids:Landroid/util/SparseBooleanArray;
    ...
    .line 97
    .local v3, "uid":I
    iget-object v4, v0, Lcom/android/settings_exlib/net/ChartData;->detailDefault:Landroid/net/NetworkStatsHistory;

    .line 96
    invoke-direct {p0, p1, v3, v8, v4}, Lcom/android/settings_exlib/net/ChartDataLoader;->collectHistoryForUid(Landroid/net/NetworkTemplate;IILandroid/net/NetworkStatsHistory;)Landroid/net/NetworkStatsHistory;

    move-result-object v4

    iput-object v4, v0, Lcom/android/settings_exlib/net/ChartData;->detailDefault:Landroid/net/NetworkStatsHistory;

    .line 99
    iget-object v4, v0, Lcom/android/settings_exlib/net/ChartData;->detailForeground:Landroid/net/NetworkStatsHistory;

    const/4 v5, 0x1

    .line 98
    invoke-direct {p0, p1, v3, v5, v4}, Lcom/android/settings_exlib/net/ChartDataLoader;->collectHistoryForUid(Landroid/net/NetworkTemplate;IILandroid/net/NetworkStatsHistory;)Landroid/net/NetworkStatsHistory;

    move-result-object v4

    iput-object v4, v0, Lcom/android/settings_exlib/net/ChartData;->detailForeground:Landroid/net/NetworkStatsHistory;
    ...
    iput-object v4, v0, Lcom/android/settings_exlib/net/ChartData;->detail:Landroid/net/NetworkStatsHistory;

    .line 104
    iget-object v4, v0, Lcom/android/settings_exlib/net/ChartData;->detail:Landroid/net/NetworkStatsHistory;
