...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/settings_exlib/datetime/ZoneGetter$ZoneInfo;
    }
.end annotation
...
.method public static getTimeZoneOffsetAndName(Ljava/util/TimeZone;Ljava/util/Date;)Ljava/lang/String;
    ...
    invoke-static {v1, p0, p1}, Lcom/android/settings_exlib/datetime/ZoneGetter;->getGmtOffsetString(Ljava/util/Locale;Ljava/util/TimeZone;Ljava/util/Date;)Ljava/lang/String;

    move-result-object v0

    .line 60
    .local v0, "gmtString":Ljava/lang/String;
    invoke-static {v1, p0, p1}, Lcom/android/settings_exlib/datetime/ZoneGetter;->getZoneLongName(Ljava/util/Locale;Ljava/util/TimeZone;Ljava/util/Date;)Ljava/lang/String;
...
.method public static getZonesList(Landroid/content/Context;)Ljava/util/List;
    ...
    .line 92
    .local v16, "olsonIdsToDisplay":Ljava/util/List;, "Ljava/util/List<Lcom/android/settings_exlib/datetime/ZoneGetter$ZoneInfo;>;"
    ...
    check-cast v19, Lcom/android/settings_exlib/datetime/ZoneGetter$ZoneInfo;

    .line 102
    .local v19, "zoneInfo":Lcom/android/settings_exlib/datetime/ZoneGetter$ZoneInfo;
    move-object/from16 v0, v19

    iget-object v0, v0, Lcom/android/settings_exlib/datetime/ZoneGetter$ZoneInfo;->mOlsonId:Ljava/lang/String;
    ...
    iget-boolean v0, v0, Lcom/android/settings_exlib/datetime/ZoneGetter$ZoneInfo;->mLocalizeInPicker:Z
    ...
    invoke-static {v11, v0, v13}, Lcom/android/settings_exlib/datetime/ZoneGetter;->getZoneLongName(Ljava/util/Locale;Ljava/util/TimeZone;Ljava/util/Date;)Ljava/lang/String;
    ...
    .end local v19    # "zoneInfo":Lcom/android/settings_exlib/datetime/ZoneGetter$ZoneInfo;
    ...
    .line 116
    .restart local v19    # "zoneInfo":Lcom/android/settings_exlib/datetime/ZoneGetter$ZoneInfo;
    move-object/from16 v0, v19
    ...
    invoke-static {v11, v0, v13, v1}, Lcom/android/settings_exlib/datetime/ZoneGetter;->getZoneDisplayName(Ljava/util/Locale;Ljava/util/TimeZone;Ljava/util/Date;Z)Ljava/lang/String;
    ...
    invoke-static {v11, v0, v13}, Lcom/android/settings_exlib/datetime/ZoneGetter;->getGmtOffsetString(Ljava/util/Locale;Ljava/util/TimeZone;Ljava/util/Date;)Ljava/lang/String;
    ...
    invoke-static {v0, v6, v5, v14}, Lcom/android/settings_exlib/datetime/ZoneGetter;->createDisplayEntry(Ljava/util/TimeZone;Ljava/lang/String;Ljava/lang/String;I)Ljava/util/Map;
...
.method private static readTimezonesToDisplay(Landroid/content/Context;)Ljava/util/List;
    ...
    .line 169
    .local v3, "olsonIds":Ljava/util/List;, "Ljava/util/List<Lcom/android/settings_exlib/datetime/ZoneGetter$ZoneInfo;>;"
    const/4 v5, 0x0
    ...
    sget v8, Lcom/android/settings_exlib/R$xml;->timezones:I
    ...
    .line 185
    .local v1, "localize":Z
    new-instance v6, Lcom/android/settings_exlib/datetime/ZoneGetter$ZoneInfo;

    invoke-direct {v6, v2, v1}, Lcom/android/settings_exlib/datetime/ZoneGetter$ZoneInfo;-><init>(Ljava/lang/String;Z)V
