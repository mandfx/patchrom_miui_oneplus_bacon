...
.method private updateAccessPoints()V
    ...
    .line 302
    .local v6, "cachedAccessPoints":Ljava/util/List;, "Ljava/util/List<Lcom/android/settings_exlib/wifi/AccessPoint;>;"
    ...
    :cond_0
    new-instance v5, Lcom/android/settings_exlib/wifi/WifiTracker$Multimap;

    const/16 v20, 0x0

    move-object/from16 v0, v20

    invoke-direct {v5, v0}, Lcom/android/settings_exlib/wifi/WifiTracker$Multimap;-><init>(Lcom/android/settings_exlib/wifi/WifiTracker$Multimap;)V

    .line 312
    .local v5, "apMap":Lcom/android/settings_exlib/wifi/WifiTracker$Multimap;, "Lcom/android/settings_exlib/wifi/WifiTracker$Multimap<Ljava/lang/String;Lcom/android/settings_exlib/wifi/AccessPoint;>;"
    const/4 v10, 0x0
    ...
    invoke-direct {v0, v7, v6}, Lcom/android/settings_exlib/wifi/WifiTracker;->getCachedOrCreate(Landroid/net/wifi/WifiConfiguration;Ljava/util/List;)Lcom/android/settings_exlib/wifi/AccessPoint;
    ...
    invoke-virtual {v2, v10, v0, v1}, Lcom/android/settings_exlib/wifi/AccessPoint;->update(Landroid/net/wifi/WifiConfiguration;Landroid/net/wifi/WifiInfo;Landroid/net/NetworkInfo;)Z
    ...
    invoke-virtual {v5, v0, v2}, Lcom/android/settings_exlib/wifi/WifiTracker$Multimap;->put(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-virtual {v5, v0}, Lcom/android/settings_exlib/wifi/WifiTracker$Multimap;->getAll(Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-direct {v0, v1, v6}, Lcom/android/settings_exlib/wifi/WifiTracker;->getCachedOrCreate(Landroid/net/wifi/ScanResult;Ljava/util/List;)Lcom/android/settings_exlib/wifi/AccessPoint;
    ...
    .line 372
    invoke-virtual {v2, v7}, Lcom/android/settings_exlib/wifi/AccessPoint;->update(Landroid/net/wifi/WifiConfiguration;)V
    ...
    .line 381
    invoke-virtual {v2, v10}, Lcom/android/settings_exlib/wifi/AccessPoint;->update(Landroid/net/wifi/WifiConfiguration;)V
    ...
    .line 396
    .local v14, "prevAccessPoint":Lcom/android/settings_exlib/wifi/AccessPoint;
    ...
    .line 397
    invoke-virtual {v14}, Lcom/android/settings_exlib/wifi/AccessPoint;->getSsidStr()Ljava/lang/String;
    ...
    .end local v14    # "prevAccessPoint":Lcom/android/settings_exlib/wifi/AccessPoint;
    ...
    invoke-virtual/range {v20 .. v21}, Lcom/android/settings_exlib/wifi/WifiTracker$MainHandler;->sendEmptyMessage(I)Z
...
.method public resumeScanning()V
    ...
    invoke-virtual {v0, v2}, Lcom/android/settings_exlib/wifi/WifiTracker$WorkHandler;->hasMessages(I)Z
    ...
    invoke-virtual {v0, v2}, Lcom/android/settings_exlib/wifi/WifiTracker$WorkHandler;->sendEmptyMessage(I)Z
