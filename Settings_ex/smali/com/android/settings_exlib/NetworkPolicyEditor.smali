.class public Lcom/android/settings_exlib/NetworkPolicyEditor;
...
.method public constructor <init>(Landroid/net/NetworkPolicyManager;)V
    ...
    iput-object v0, p0, Lcom/android/settings_exlib/NetworkPolicyEditor;->mPolicies:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lcom/android/settings_exlib/NetworkPolicyEditor;->mPolicyManager:Landroid/net/NetworkPolicyManager;
...
.method public getOrCreatePolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
    ...
    .prologue
    .line 102
    invoke-virtual {p0, p1}, Lcom/android/settings_exlib/NetworkPolicyEditor;->getPolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
    ...
    .line 104
    invoke-static {p1}, Lcom/android/settings_exlib/NetworkPolicyEditor;->buildDefaultPolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;

    move-result-object v0

    .line 105
    iget-object v1, p0, Lcom/android/settings_exlib/NetworkPolicyEditor;->mPolicies:Ljava/util/ArrayList;
...
.method public getPolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
    ...
    .prologue
    .line 111
    iget-object v2, p0, Lcom/android/settings_exlib/NetworkPolicyEditor;->mPolicies:Ljava/util/ArrayList;
...
.method public getPolicyMaybeUnquoted(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
    ...
    .line 124
    :cond_0
    invoke-static {p1}, Lcom/android/settings_exlib/NetworkPolicyEditor;->buildUnquotedNetworkTemplate(Landroid/net/NetworkTemplate;)Landroid/net/NetworkTemplate;

    move-result-object v1

    invoke-virtual {p0, v1}, Lcom/android/settings_exlib/NetworkPolicyEditor;->getPolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
...
.method public read()V
    ...
    .line 58
    iget-object v3, p0, Lcom/android/settings_exlib/NetworkPolicyEditor;->mPolicyManager:Landroid/net/NetworkPolicyManager;
    ...
    .line 61
    .local v0, "modified":Z
    iget-object v3, p0, Lcom/android/settings_exlib/NetworkPolicyEditor;->mPolicies:Ljava/util/ArrayList;
    ...
    .line 73
    :cond_1
    iget-object v5, p0, Lcom/android/settings_exlib/NetworkPolicyEditor;->mPolicies:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0}, Lcom/android/settings_exlib/NetworkPolicyEditor;->writeAsync()V
...
.method public setPolicyCycleDay(Landroid/net/NetworkTemplate;ILjava/lang/String;)V
    ...
    .prologue
    .line 157
    invoke-virtual {p0, p1}, Lcom/android/settings_exlib/NetworkPolicyEditor;->getOrCreatePolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
...
.method public setPolicyMetered(Landroid/net/NetworkTemplate;Z)V
    ...
    .line 209
    iget-object v4, p0, Lcom/android/settings_exlib/NetworkPolicyEditor;->mPolicies:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v2}, Lcom/android/settings_exlib/NetworkPolicyEditor;->getPolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
...
.method public write([Landroid/net/NetworkPolicy;)V
    ...
    .prologue
    .line 93
    iget-object v0, p0, Lcom/android/settings_exlib/NetworkPolicyEditor;->mPolicyManager:Landroid/net/NetworkPolicyManager;
...
.method public writeAsync()V
    ...
    new-instance v1, Lcom/android/settings_exlib/NetworkPolicyEditor$1;

    invoke-direct {v1, p0, v0}, Lcom/android/settings_exlib/NetworkPolicyEditor$1;-><init>(Lcom/android/settings_exlib/NetworkPolicyEditor;[Landroid/net/NetworkPolicy;)V

    const/4 v2, 0x0

    new-array v2, v2, [Ljava/lang/Void;

    invoke-virtual {v1, v2}, Lcom/android/settings_exlib/NetworkPolicyEditor$1;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
