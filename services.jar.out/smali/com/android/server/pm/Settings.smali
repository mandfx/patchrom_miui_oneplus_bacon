...
.method private getPackageLPw(Ljava/lang/String;Lcom/android/server/pm/PackageSetting;Ljava/lang/String;Lcom/android/server/pm/SharedUserSetting;Ljava/io/File;Ljava/io/File;Ljava/lang/String;IILandroid/os/UserHandle;ZZ)Lcom/android/server/pm/PackageSetting;
    ...
    iget-object v0, v3, Lcom/android/server/pm/PackageSettingBase;->signatures:Lcom/android/server/pm/PackageSignatures;

    move-object/from16 v17, v0

    .line 449
    .local v17, s:Lcom/android/server/pm/PackageSignatures;
    move-object/from16 v0, p2
    ...
    iput-object v0, v3, Lcom/android/server/pm/PackageSettingBase;->signatures:Lcom/android/server/pm/PackageSignatures;
    ...
    .line 527
    .end local v17           #s:Lcom/android/server/pm/PackageSignatures;
    :goto_4
    ...
    invoke-virtual/range {v3 .. v14}, Lcom/android/server/pm/PackageSettingBase;->setUserState(IIZZZZLjava/lang/String;Ljava/util/HashSet;Ljava/util/HashSet;Ljava/util/HashSet;Ljava/util/HashSet;)V
    ...
    .line 502
    iget-object v4, v15, Lcom/android/server/pm/PackageSettingBase;->signatures:Lcom/android/server/pm/PackageSignatures;
    ...
    .line 505
    :cond_b
    iget v4, v15, Lcom/android/server/pm/PackageSetting;->appId:I
    ...
    iget-object v5, v15, Lcom/android/server/pm/GrantedPermissions;->grantedPermissions:Ljava/util/HashSet;
    ...
    invoke-virtual {v15, v0}, Lcom/android/server/pm/PackageSettingBase;->getDisabledComponents(I)Ljava/util/HashSet;
    ...
    invoke-virtual {v15, v0}, Lcom/android/server/pm/PackageSettingBase;->getEnabledComponents(I)Ljava/util/HashSet;
...
.method private readPermissionsLPw(Ljava/util/HashMap;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    iput-object v10, v4, Landroid/content/pm/PackageItemInfo;->packageName:Ljava/lang/String;
    ...
    iput-object v10, v4, Landroid/content/pm/PackageItemInfo;->name:Ljava/lang/String;
    ...
    iput v10, v4, Landroid/content/pm/PackageItemInfo;->icon:I
    ...
    iput-object v10, v4, Landroid/content/pm/PackageItemInfo;->nonLocalizedLabel:Ljava/lang/CharSequence;
...
.method createNewUserLILPw(Lcom/android/server/pm/PackageManagerService;Lcom/android/server/pm/Installer;ILjava/io/File;)V
    ...
    iget-boolean v3, v3, Landroid/content/pm/PackageParser$Package;->mIsLegacyThemeApk:Z

    if-nez v3, :cond_0

    iget-object v3, v2, Lcom/android/server/pm/PackageSetting;->pkg:Landroid/content/pm/PackageParser$Package;

    iget-boolean v3, v3, Landroid/content/pm/PackageParser$Package;->mIsLegacyIconPackApk:Z
    ...
    :goto_1
    invoke-virtual {v2, v1, p3}, Lcom/android/server/pm/PackageSettingBase;->setInstalled(ZI)V
...
.method readPackageRestrictionsLPr(I)V
    ...
    .line 849
    .local v32, userPackagesStateFile:Ljava/io/File;
    ...
    const-string v33, "Reading from backup stopped packages file\n"
    ...
    const-string v33, "Need to read from backup stopped packages file"
    ...
    const-string v34, "Cleaning up stopped packages file "
    ...
    const-string v33, "No stopped packages file found\n"
    ...
    const-string v33, "No stopped packages file; assuming all started"
    ...
    const-string v34, "Error reading: "
    ...
    const-string v34, "Error reading stopped packages: "
    ...
    const-string v33, "Error reading package manager stopped packages"
    ...
    const-string v33, "No start tag found in package restrictions file\n"
    ...
    const-string v33, "No start tag found in package manager stopped packages"
    ...
    const-string v34, "No package known for stopped package: "
    ...
    const-string v34, "Error reading settings: "
    ...
    const-string v33, "enabledCaller"
    ...
    .line 934
    .local v21, installedStr:Ljava/lang/String;
    if-nez v21, :cond_c
    ...
    .line 937
    .local v27, stoppedStr:Ljava/lang/String;
    if-nez v27, :cond_d
    ...
    .line 943
    .local v23, notLaunchedStr:Ljava/lang/String;
    if-nez v27, :cond_f
    ...
    .line 949
    .local v14, protectedComponents:Ljava/util/HashSet;,"Ljava/util/HashSet<Ljava/lang/String;>;"
    const/4 v15, 0x0

    .line 951
    .local v15, visibleComponents:Ljava/util/HashSet;,"Ljava/util/HashSet<Ljava/lang/String;>;"
    invoke-interface/range {v26 .. v26}, Lorg/xmlpull/v1/XmlPullParser;->getDepth()I

    move-result v25

    .line 953
    .local v25, packageDepth:I
    :cond_9
    :goto_d
    invoke-interface/range {v26 .. v26}, Lorg/xmlpull/v1/XmlPullParser;->next()I
    ...
    .end local v14           #protectedComponents:Ljava/util/HashSet;,"Ljava/util/HashSet<Ljava/lang/String;>;"
    .end local v15           #visibleComponents:Ljava/util/HashSet;,"Ljava/util/HashSet<Ljava/lang/String;>;"
    .end local v17           #blockedStr:Ljava/lang/String;
    .end local v21           #installedStr:Ljava/lang/String;
    .end local v23           #notLaunchedStr:Ljava/lang/String;
    .end local v25           #packageDepth:I
    .end local v27           #stoppedStr:Ljava/lang/String;
    :cond_b
    invoke-static/range {v19 .. v19}, Ljava/lang/Integer;->parseInt(Ljava/lang/String;)I
    ...
    .restart local v21       #installedStr:Ljava/lang/String;
    :cond_c
    ...
    .restart local v27       #stoppedStr:Ljava/lang/String;
    :cond_d
    ...
    .restart local v23       #notLaunchedStr:Ljava/lang/String;
    :cond_f
    ...
    .restart local v14       #protectedComponents:Ljava/util/HashSet;,"Ljava/util/HashSet<Ljava/lang/String;>;"
    .restart local v15       #visibleComponents:Ljava/util/HashSet;,"Ljava/util/HashSet<Ljava/lang/String;>;"
    .restart local v25       #packageDepth:I
    :cond_10
    ...
    .line 971
    invoke-virtual/range {v4 .. v15}, Lcom/android/server/pm/PackageSettingBase;->setUserState(IIZZZZLjava/lang/String;Ljava/util/HashSet;Ljava/util/HashSet;Ljava/util/HashSet;Ljava/util/HashSet;)V
    ...
    const-string v34, "Unknown element under <stopped-packages>: "
...
.method setPackageStoppedStateLPw(Ljava/lang/String;ZZII)Z
    ...
    .line 2875
    :cond_1
    invoke-virtual {v8, p5}, Lcom/android/server/pm/PackageSettingBase;->getStopped(I)Z
    ...
    .line 2876
    invoke-virtual {v8, p2, p5}, Lcom/android/server/pm/PackageSettingBase;->setStopped(ZI)V

    .line 2878
    invoke-virtual {v8, p5}, Lcom/android/server/pm/PackageSettingBase;->getNotLaunched(I)Z
    ...
    iget-object v4, v8, Lcom/android/server/pm/PackageSettingBase;->installerPackageName:Ljava/lang/String;
    ...
    invoke-virtual {v8, v0, p5}, Lcom/android/server/pm/PackageSettingBase;->setNotLaunched(ZI)V
...
.method writePackageRestrictionsLPr(I)V
    ...
    :cond_5
    iget-object v13, v12, Landroid/content/pm/PackageUserState;->protectedComponents:Ljava/util/HashSet;
    ...
    :cond_6
    iget-object v13, v12, Landroid/content/pm/PackageUserState;->visibleComponents:Ljava/util/HashSet;
